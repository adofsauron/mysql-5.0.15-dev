...
sp_head *sp_find_procedure(THD *thd, sp_name *name, bool cache_only = 0);

int sp_exists_routine(THD *thd, TABLE_LIST *procs, bool any, bool no_error);
...
sp_head *sp_find_function(THD *thd, sp_name *name, bool cache_only = 0);
