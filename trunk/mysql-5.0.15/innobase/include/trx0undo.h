...
UNIV_INLINE
dulint trx_undo_build_roll_ptr(
    /*====================*/
    /* out: roll pointer */
...
UNIV_INLINE
ibool trx_undo_roll_ptr_is_insert(
    /*========================*/
...
UNIV_INLINE
page_t *trx_undo_page_get_s_latched(
    /*=========================*/
