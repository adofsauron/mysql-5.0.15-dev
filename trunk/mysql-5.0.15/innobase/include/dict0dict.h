...
void dict_load_space_id_list(void);
/*=========================*/
/*************************************************************************
Gets the column data type. */
UNIV_INLINE
dtype_t *dict_col_get_type(
    /*==============*/
    dict_col_t *col);
/*************************************************************************
Gets the column number. */
UNIV_INLINE
ulint dict_col_get_no(
    /*============*/
    dict_col_t *col);
/*************************************************************************
...
Returns a table object, based on table id, and memoryfixes it. */
UNIV_INLINE
dict_table_t *dict_table_get_on_id_low(
    /*=====================*/
    /* out: table, NULL if does not exist */
    dulint table_id, /* in: table id */
    trx_t *trx);     /* in: transaction handle */
...
UNIV_INLINE
dict_index_t *dict_table_get_index(
    /*=================*/
...
UNIV_INLINE
dict_index_t *dict_table_get_first_index(
    /*=======================*/
...
UNIV_INLINE
dict_index_t *dict_table_get_next_index(
    /*======================*/
...
UNIV_INLINE
ulint dict_table_get_n_sys_cols(
    /*======================*/
...
UNIV_INLINE
dict_col_t *dict_table_get_nth_col(
    /*===================*/
...
UNIV_INLINE
dict_col_t *dict_table_get_sys_col(
    /*===================*/
    /* out: pointer to column object */
    dict_table_t *table, /* in: table */
...
UNIV_INLINE
ulint dict_table_get_sys_col_no(
    /*======================*/
    /* out: column number */
    dict_table_t *table, /* in: table */
    ulint sys);          /* in: DATA_ROW_ID, ... */
...
UNIV_INLINE
dict_field_t *dict_index_get_nth_field(
    /*=====================*/
...
UNIV_INLINE
dtype_t *dict_index_get_nth_type(
    /*====================*/
    /* out: data type */
    dict_index_t *index, /* in: index */
...
UNIV_INLINE
ulint dict_index_get_nth_col_no(
    /*======================*/
    /* out: column number */
    dict_index_t *index, /* in: index */
    ulint pos);          /* in: position of the field */
...
UNIV_INLINE
ulint dict_index_get_sys_col_pos(
    /*=======================*/
...
UNIV_INLINE
dict_tree_t *dict_index_get_tree(
    /*================*/
    /* out: index tree */
    dict_index_t *index); /* in: index */
/*************************************************************************
...
UNIV_INLINE
ulint dict_field_get_order(
    /*=================*/
    dict_field_t *field);
/*************************************************************************
Gets the field column. */
UNIV_INLINE
dict_col_t *dict_field_get_col(
    /*===============*/
    dict_field_t *field);
/**************************************************************************
...
UNIV_INLINE
ulint dict_tree_get_space_reserve(
    /*========================*/
