...
TYPELIB bool_typelib = { array_elements(bool_type_names) - 1, "",
                         bool_type_names,                     NULL };

const char *delay_key_write_type_names[] = { "OFF", "ON", "ALL", NullS };
TYPELIB delay_key_write_typelib = { array_elements(delay_key_write_type_names) -
                                        1,
...
sys_character_set_database("character_set_database");
...
sys_character_set_results("character_set_results");
sys_var_thd_ulong sys_completion_type("completion_type", &SV::completion_type,
...
sys_var_enum sys_delay_key_write("delay_key_write", &delay_key_write_options,
                                 &delay_key_write_typelib, fix_delay_key_write);
...
sys_var_str sys_ft_boolean_syntax("ft_boolean_syntax", sys_check_ftb_syntax,
                                  sys_update_ftb_syntax, sys_default_ftb_syntax,
                                  ft_boolean_syntax);
sys_var_str sys_init_connect("init_connect", 0, sys_update_init_connect,
                             sys_default_init_connect, 0);
sys_var_str sys_init_slave("init_slave", 0, sys_update_init_slave,
...
sys_var_bool_ptr sys_trust_routine_creators("log_bin_trust_routine_creators",
...
sys_var_long_ptr sys_max_binlog_size("max_binlog_size", &max_binlog_size,
                                     fix_max_binlog_size);
sys_var_long_ptr sys_max_connections("max_connections", &max_connections,
                                     fix_max_connections);
sys_var_long_ptr sys_max_connect_errors("max_connect_errors",
                                        &max_connect_errors);
sys_var_thd_ulong
sys_max_insert_delayed_threads("max_insert_delayed_threads",
...
sys_var_thd_ha_rows sys_max_join_size("max_join_size", &SV::max_join_size,
                                      fix_max_join_size);
...
sys_var_long_ptr sys_query_cache_size("query_cache_size", &query_cache_size,
...
sys_var_thd_enum sys_query_cache_type("query_cache_type", &SV::query_cache_type,
...
sys_var_thd_ulong sys_sync_replication("sync_replication",
                                       &SV::sync_replication);
sys_var_thd_ulong sys_sync_replication_slave_id("sync_replication_slave_id",
                                                &SV::sync_replication_slave_id);
sys_var_thd_ulong sys_sync_replication_timeout("sync_replication_timeout",
...
sys_var_thd_enum sys_tx_isolation("tx_isolation", &SV::tx_isolation,
                                  &tx_isolation_typelib, fix_tx_isolation);
...
sys_var_thd_bool sys_engine_condition_pushdown("engine_condition_pushdown",
...
sys_var_thd_bool sys_ndb_use_exact_count("ndb_use_exact_count",
                                         &SV::ndb_use_exact_count);
sys_var_thd_bool sys_ndb_use_transactions("ndb_use_transactions",
...
sys_var_thd_date_time_format sys_time_format("time_format", &SV::time_format,
                                             MYSQL_TIMESTAMP_TIME);
sys_var_thd_date_time_format sys_date_format("date_format", &SV::date_format,
...
sys_var_thd_bit sys_autocommit("autocommit", 0, set_option_autocommit,
                               OPTION_NOT_AUTOCOMMIT, 1);
static sys_var_thd_bit sys_big_tables("big_tables", 0, set_option_bit,
                                      OPTION_BIG_TABLES);
#ifndef TO_BE_DELETED /* Alias for big_tables */
static sys_var_thd_bit sys_sql_big_tables("sql_big_tables", 0, set_option_bit,
                                          OPTION_BIG_TABLES);
#endif
static sys_var_thd_bit sys_big_selects("sql_big_selects", 0, set_option_bit,
                                       OPTION_BIG_SELECTS);
static sys_var_thd_bit sys_log_off("sql_log_off", 0, set_option_bit,
                                   OPTION_LOG_OFF);
static sys_var_thd_bit sys_log_update("sql_log_update", check_log_update,
                                      set_log_update, OPTION_UPDATE_LOG);
static sys_var_thd_bit sys_log_binlog("sql_log_bin", check_log_update,
                                      set_log_bin, OPTION_BIN_LOG);
static sys_var_thd_bit sys_sql_warnings("sql_warnings", 0, set_option_bit,
                                        OPTION_WARNINGS);
static sys_var_thd_bit sys_sql_notes("sql_notes", 0, set_option_bit,
                                     OPTION_SQL_NOTES);
static sys_var_thd_bit sys_auto_is_null("sql_auto_is_null", 0, set_option_bit,
                                        OPTION_AUTO_IS_NULL);
static sys_var_thd_bit sys_safe_updates("sql_safe_updates", 0, set_option_bit,
                                        OPTION_SAFE_UPDATES);
static sys_var_thd_bit sys_buffer_results("sql_buffer_result", 0,
                                          set_option_bit, OPTION_BUFFER_RESULT);
...
static sys_var_thd_bit sys_unique_checks("unique_checks", 0, set_option_bit,
...
static sys_var_readonly sys_error_count("error_count", OPT_SESSION, SHOW_LONG,
                                        get_error_count);
static sys_var_readonly sys_warning_count("warning_count", OPT_SESSION,
                                          SHOW_LONG, get_warning_count);

/* alias for last_insert_id() to be compatible with Sybase */
#ifdef HAVE_REPLICATION
static sys_var_slave_skip_counter
...
sys_var_readonly sys_have_innodb("have_innodb", OPT_GLOBAL, SHOW_CHAR,
                                 get_have_innodb);
...
sys_var *sys_variables[] = {
  &sys_auto_is_null,                  &sys_auto_increment_increment,
  &sys_auto_increment_offset,         &sys_autocommit,
  &sys_automatic_sp_privileges,       &sys_big_tables,
  &sys_big_selects,                   &sys_binlog_cache_size,
  &sys_buffer_results,                &sys_bulk_insert_buff_size,
  &sys_character_set_server,          &sys_character_set_database,
  &sys_character_set_client,          &sys_character_set_connection,
  &sys_character_set_results,         &sys_charset_system,
  &sys_collation_connection,          &sys_collation_database,
  &sys_collation_server,              &sys_completion_type,
  &sys_concurrent_insert,             &sys_connect_timeout,
  &sys_date_format,                   &sys_datetime_format,
  &sys_div_precincrement,             &sys_default_week_format,
  &sys_delay_key_write,               &sys_delayed_insert_limit,
  &sys_delayed_insert_timeout,        &sys_delayed_queue_size,
  &sys_error_count,                   &sys_expire_logs_days,
  &sys_flush,                         &sys_flush_time,
  &sys_ft_boolean_syntax,             &sys_foreign_key_checks,
  &sys_group_concat_max_len,          &sys_have_innodb,
  &sys_identity,                      &sys_init_connect,
  &sys_init_slave,                    &sys_insert_id,
  &sys_interactive_timeout,           &sys_join_buffer_size,
  &sys_key_buffer_size,               &sys_key_cache_block_size,
  &sys_key_cache_division_limit,      &sys_key_cache_age_threshold,
  &sys_last_insert_id,                &sys_license,
  &sys_local_infile,                  &sys_log_binlog,
  &sys_log_off,                       &sys_log_update,
  &sys_log_warnings,                  &sys_long_query_time,
  &sys_low_priority_updates,          &sys_max_allowed_packet,
  &sys_max_binlog_cache_size,         &sys_max_binlog_size,
  &sys_max_connect_errors,            &sys_max_connections,
  &sys_max_delayed_threads,           &sys_max_error_count,
  ...
  &sys_max_sort_length,               &sys_max_tmp_tables,
  &sys_max_user_connections,          &sys_max_write_lock_count,
  &sys_multi_range_count,             &sys_myisam_data_pointer_size,
  &sys_myisam_max_sort_file_size,     &sys_myisam_repair_threads,
  &sys_myisam_sort_buffer_size,       &sys_myisam_stats_method,
  &sys_net_buffer_length,             &sys_net_read_timeout,
  &sys_net_retry_count,               &sys_net_wait_timeout,
  &sys_net_write_timeout,             &sys_new_mode,
  &sys_old_passwords,                 &sys_optimizer_prune_level,
  &sys_optimizer_search_depth,        &sys_preload_buff_size,
  &sys_pseudo_thread_id,              &sys_query_alloc_block_size,
  &sys_query_cache_size,              &sys_query_prealloc_size,
#ifdef HAVE_QUERY_CACHE
  &sys_query_cache_limit,             &sys_query_cache_min_res_unit,
  &sys_query_cache_type,              &sys_query_cache_wlock_invalidate,
#endif /* HAVE_QUERY_CACHE */
  &sys_quote_show_create,             &sys_rand_seed1,
  &sys_rand_seed2,                    &sys_range_alloc_block_size,
  &sys_readonly,                      &sys_read_buff_size,
  &sys_read_rnd_buff_size,
#ifdef HAVE_REPLICATION
  &sys_relay_log_purge,
#endif
  &sys_rpl_recovery_rank,             &sys_safe_updates,
  &sys_secure_auth,                   &sys_select_limit,
  &sys_server_id,
#ifdef HAVE_REPLICATION
  &sys_slave_compressed_protocol,     &sys_slave_net_timeout,
  &sys_slave_trans_retries,           &sys_slave_skip_counter,
#endif
  &sys_slow_launch_time,              &sys_sort_buffer,
  &sys_sql_big_tables,                &sys_sql_low_priority_updates,
  &sys_sql_max_join_size,             &sys_sql_mode,
  &sys_sql_warnings,                  &sys_sql_notes,
  &sys_storage_engine,
#ifdef HAVE_REPLICATION
  &sys_sync_binlog_period,            &sys_sync_replication,
  &sys_sync_replication_slave_id,     &sys_sync_replication_timeout,
#endif
  &sys_sync_frm,                      &sys_table_cache_size,
  &sys_table_lock_wait_timeout,       &sys_table_type,
  &sys_thread_cache_size,             &sys_time_format,
  &sys_timed_mutexes,                 &sys_timestamp,
  &sys_time_zone,                     &sys_tmp_table_size,
  &sys_trans_alloc_block_size,        &sys_trans_prealloc_size,
  &sys_tx_isolation,                  &sys_os,
#ifdef HAVE_INNOBASE_DB
  &sys_innodb_fast_shutdown,          &sys_innodb_max_dirty_pages_pct,
  &sys_innodb_max_purge_lag,          &sys_innodb_table_locks,
  &sys_innodb_support_xa,             &sys_innodb_max_purge_lag,
  &sys_innodb_autoextend_increment,   &sys_innodb_sync_spin_loops,
  &sys_innodb_concurrency_tickets,    &sys_innodb_thread_sleep_delay,
  &sys_innodb_thread_concurrency,     &sys_innodb_commit_concurrency,
#endif
  &sys_trust_routine_creators,        &sys_engine_condition_pushdown,
#ifdef HAVE_NDBCLUSTER_DB
  &sys_ndb_autoincrement_prefetch_sz, &sys_ndb_cache_check_time,
  &sys_ndb_force_send,                &sys_ndb_use_exact_count,
  &sys_ndb_use_transactions,
#endif
  &sys_unique_checks,                 &sys_updatable_views_with_limit,
  &sys_warning_count
};
...
struct show_var_st init_vars[] = {
  { "auto_increment_increment", (char *)&sys_auto_increment_increment,
    SHOW_SYS },
  ...
  { sys_bulk_insert_buff_size.name, (char *)&sys_bulk_insert_buff_size,
    SHOW_SYS },
  ...
  { sys_character_set_connection.name, (char *)&sys_character_set_connection,
    SHOW_SYS },
  { sys_character_set_database.name, (char *)&sys_character_set_database,
    SHOW_SYS },
  { sys_character_set_results.name, (char *)&sys_character_set_results,
    SHOW_SYS },
  { sys_character_set_server.name, (char *)&sys_character_set_server,
    SHOW_SYS },
  { sys_charset_system.name, (char *)&sys_charset_system, SHOW_SYS },
  { "character_sets_dir", mysql_charsets_dir, SHOW_CHAR },
  { sys_collation_connection.name, (char *)&sys_collation_connection,
    SHOW_SYS },
  ...
  { sys_delayed_insert_limit.name, (char *)&sys_delayed_insert_limit,
    SHOW_SYS },
  { sys_delayed_insert_timeout.name, (char *)&sys_delayed_insert_timeout,
    SHOW_SYS },
  { sys_delayed_queue_size.name, (char *)&sys_delayed_queue_size, SHOW_SYS },
  { sys_div_precincrement.name, (char *)&sys_div_precincrement, SHOW_SYS },
  { sys_engine_condition_pushdown.name, (char *)&sys_engine_condition_pushdown,
    SHOW_SYS },
  ...
  { sys_group_concat_max_len.name, (char *)&sys_group_concat_max_len,
    SHOW_SYS },
  ...
  { "innodb_additional_mem_pool_size",
    (char *)&innobase_additional_mem_pool_size, SHOW_LONG },
  { sys_innodb_autoextend_increment.name,
    (char *)&sys_innodb_autoextend_increment, SHOW_SYS },
  ...
  { sys_innodb_commit_concurrency.name, (char *)&sys_innodb_commit_concurrency,
    SHOW_SYS },
  { sys_innodb_concurrency_tickets.name,
    (char *)&sys_innodb_concurrency_tickets, SHOW_SYS },
  ...
  { "innodb_lock_wait_timeout", (char *)&innobase_lock_wait_timeout,
    SHOW_LONG },
  ...
  { "innodb_log_files_in_group", (char *)&innobase_log_files_in_group,
    SHOW_LONG },
  { "innodb_log_group_home_dir", (char *)&innobase_log_group_home_dir,
    SHOW_CHAR_PTR },
  { sys_innodb_max_dirty_pages_pct.name,
    (char *)&sys_innodb_max_dirty_pages_pct, SHOW_SYS },
  ...
  { sys_innodb_sync_spin_loops.name, (char *)&sys_innodb_sync_spin_loops,
    SHOW_SYS },
  ...
  { sys_trust_routine_creators.name, (char *)&sys_trust_routine_creators,
    SHOW_SYS },
  ...
  { sys_low_priority_updates.name, (char *)&sys_low_priority_updates,
    SHOW_SYS },
  { "lower_case_file_system", (char *)&lower_case_file_system, SHOW_MY_BOOL },
  { "lower_case_table_names", (char *)&lower_case_table_names, SHOW_INT },
  { sys_max_allowed_packet.name, (char *)&sys_max_allowed_packet, SHOW_SYS },
  { sys_max_binlog_cache_size.name, (char *)&sys_max_binlog_cache_size,
    SHOW_SYS },
  ...
  { sys_max_user_connections.name, (char *)&sys_max_user_connections,
    SHOW_SYS },
  ...
  { sys_ndb_use_transactions.name, (char *)&sys_ndb_use_transactions,
    SHOW_SYS },
  { sys_ndb_cache_check_time.name, (char *)&sys_ndb_cache_check_time,
    SHOW_SYS },
#endif
...
#ifdef HAVE_REPLICATION
  { sys_slave_compressed_protocol.name, (char *)&sys_slave_compressed_protocol,
    SHOW_SYS },
  ...
  { sys_sync_replication_slave_id.name, (char *)&sys_sync_replication_slave_id,
    SHOW_SYS },
  { sys_sync_replication_timeout.name, (char *)&sys_sync_replication_timeout,
    SHOW_SYS },
#endif
#ifdef HAVE_TZNAME
...
static int sys_check_ftb_syntax(THD *thd, set_var *var) {
  if (thd->security_ctx->master_access & SUPER_ACL)
    return (
        ft_boolean_check_syntax_string((byte *)var->value->str_value.c_ptr())
            ? -1
            : 0);
  else {
...
static void fix_query_cache_size(THD *thd, enum_var_type type) {
  ...
  if (requested != query_cache_size)
    push_warning_printf(current_thd, MYSQL_ERROR::WARN_LEVEL_WARN,
                        ER_WARN_QC_RESIZE, ER(ER_WARN_QC_RESIZE), requested,
                        query_cache_size);
#endif
}
  ...
  if (var->value->result_type() == STRING_RESULT) {
    if (!(res = var->value->val_str(&str)) ||
        ((long)(var->save_result.ulong_value =
                    (ulong)find_type(enum_names, res->ptr(), res->length(), 1) -
                    1)) < 0) {
...
bool sys_var::check_set(THD *thd, set_var *var, TYPELIB *enum_names) {
  ...
  if (var->value->result_type() == STRING_RESULT) {
    ...
    var->save_result.ulong_value =
        ((ulong)find_set(enum_names, res->c_ptr(), res->length(), NULL, &error,
                         &error_len, &not_used));
    if (error_len) {
...
Item *sys_var::item(THD *thd, enum_var_type var_type, LEX_STRING *base) {
  if (check_type(var_type)) {
    if (var_type != OPT_DEFAULT) {
      my_error(ER_INCORRECT_GLOBAL_LOCAL_VAR, MYF(0), name,
...
byte *sys_var_thd_enum::value_ptr(THD *thd, enum_var_type type,
                                  LEX_STRING *base) {
  ulong tmp = ((type == OPT_GLOBAL) ? global_system_variables.*offset
...
byte *sys_var_thd_bit::value_ptr(THD *thd, enum_var_type type,
  ...
  */
  thd->sys_var_tmp.my_bool_value =
      ((thd->options & bit_flag) ? !reverse : reverse);
...
bool sys_var_thd_date_time_format::update(THD *thd, set_var *var) {
  ...
  new_value =
      date_time_format_copy((THD *)0, var->save_result.date_time_format);
  if (!new_value)
...
bool sys_var_thd_date_time_format::check(THD *thd, set_var *var) {
  ...
  if (!(format =
            date_time_format_make(date_time_type, res->ptr(), res->length()))) {
...
bool sys_var_character_set::check(THD *thd, set_var *var) {
  ...
  if (var->value->result_type() == STRING_RESULT) {
    ...
    if (!(res = var->value->val_str(&str))) {
      ...
      tmp = NULL;
    } else if (!(tmp = get_charset_by_csname(res->c_ptr(), MY_CS_PRIMARY,
                                             MYF(0))) &&
...
CHARSET_INFO **sys_var_character_set_results::ci_ptr(THD *thd,
                                                     enum_var_type type) {
  if (type == OPT_GLOBAL)
...
CHARSET_INFO **sys_var_character_set_server::ci_ptr(THD *thd,
                                                    enum_var_type type) {
  if (type == OPT_GLOBAL)
...
byte *sys_var_collation_connection::value_ptr(THD *thd, enum_var_type type,
                                              LEX_STRING *base) {
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_connection
                            : thd->variables.collation_connection);
...
byte *sys_var_collation_database::value_ptr(THD *thd, enum_var_type type,
                                            LEX_STRING *base) {
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_database
...
byte *sys_var_collation_server::value_ptr(THD *thd, enum_var_type type,
                                          LEX_STRING *base) {
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_server
...
bool sys_var_key_cache_long::update(THD *thd, set_var *var) {
  ...
  if (!key_cache &&
      !(key_cache = create_key_cache(base_name->str, base_name->length))) {
    error = 1;
    goto end;
  }
...
byte *sys_var_max_user_conn::value_ptr(THD *thd, enum_var_type type,
                                       LEX_STRING *base) {
  if (type != OPT_GLOBAL && thd->user_connect &&
...
static bool set_log_update(THD *thd, set_var *var) {
  ...
  */
  ...
  if (opt_sql_bin_update) {
    ((sys_var_thd_bit *)var->var)->bit_flag |=
        (OPTION_BIN_LOG | OPTION_UPDATE_LOG);
...
sys_var *find_sys_var(const char *str, uint length) {
  sys_var *var = (sys_var *)hash_search(&system_variable_hash, (byte *)str,
...
int set_var_user::check(THD *thd) {
  ...
  */
  return (user_var_item->fix_fields(thd, (Item **)0) || user_var_item->check())
             ? -1
             : 0;
}
  ...
  if (var->value->result_type() == STRING_RESULT) {
    ...
    if (!(res = var->value->val_str(&str)) ||
        !(var->save_result.ulong_value = (ulong)(
              db_type = ha_resolve_by_name(res->ptr(), res->length()))) ||
