...
public:
  ...
  */
  ...
  Field(char *ptr_arg, uint32 length_arg, uchar *null_ptr_arg,
        uchar null_bit_arg, utype unireg_check_arg, const char *field_name_arg,
  ...
  */
  ...
  virtual void set_default() {
    my_ptrdiff_t offset =
        (my_ptrdiff_t)(table->s->default_values - table->record[0]);
    memcpy(ptr, ptr + offset, pack_length());
    if (null_ptr)
      *null_ptr =
          ((*null_ptr & (uchar) ~null_bit) | null_ptr[offset] & null_bit);
  }
  ...
  virtual int cmp_binary(const char *a, const char *b,
  ...
  */
  ...
  virtual Field *new_key_field(MEM_ROOT *root, struct st_table *new_table,
                               ...
                               uint new_null_bit);
  inline void move_field(char *ptr_arg, uchar *null_ptr_arg,
                         uchar null_bit_arg) {
    ptr = ptr_arg;
...
public:
  Field_longstr(char *ptr_arg, uint32 len_arg, uchar *null_ptr_arg,
      ...
      : Field_str(ptr_arg, len_arg, null_ptr_arg, null_bit_arg,
                  unireg_check_arg, field_name_arg, table_arg, charset) {}
...
public:
  Field_real(char *ptr_arg, uint32 len_arg, uchar *null_ptr_arg,
      ...
      : Field_num(ptr_arg, len_arg, null_ptr_arg, null_bit_arg,
                  unireg_check_arg, field_name_arg, table_arg, dec_arg,
...
public:
  Field_tiny(char *ptr_arg, uint32 len_arg, uchar *null_ptr_arg,
      ...
      : Field_num(ptr_arg, len_arg, null_ptr_arg, null_bit_arg,
                  unireg_check_arg, field_name_arg, table_arg, 0, zero_arg,
                  unsigned_arg) {}
...
public:
  ...
  Field_short(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg,
      ...
      : Field_num((char *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0, 0, NONE,
                  field_name_arg, table_arg, 0, 0, unsigned_arg) {}
  enum Item_result result_type() const { return INT_RESULT; }
...
public:
  ...
  Field_float(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg,
      ...
      : Field_real((char *)0, len_arg, maybe_null_arg ? (uchar *)"" : 0,
                   (uint)0, NONE, field_name_arg, table_arg, dec_arg, 0, 0) {}
...
public:
  Field_null(char *ptr_arg, uint32 len_arg, enum utype unireg_check_arg,
             const char *field_name_arg, struct st_table *table_arg,
             CHARSET_INFO *cs)
      : Field_str(ptr_arg, len_arg, null, 1, unireg_check_arg, field_name_arg,
                  table_arg, cs) {}
...
public:
  Field_timestamp(char *ptr_arg, uint32 len_arg, uchar *null_ptr_arg,
                  uchar null_bit_arg, enum utype unireg_check_arg,
                  const char *field_name_arg, struct st_table *table_arg,
                  CHARSET_INFO *cs);
...
public:
  Field_date(char *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
      ...
      : Field_str(ptr_arg, 10, null_ptr_arg, null_bit_arg, unireg_check_arg,
                  field_name_arg, table_arg, cs) {}
  Field_date(bool maybe_null_arg, const char *field_name_arg,
             struct st_table *table_arg, CHARSET_INFO *cs)
      : Field_str((char *)0, 10, maybe_null_arg ? (uchar *)"" : 0, 0, NONE,
                  field_name_arg, table_arg, cs) {}
...
public:
  Field_time(char *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
             enum utype unireg_check_arg, const char *field_name_arg,
             struct st_table *table_arg, CHARSET_INFO *cs)
      : Field_str(ptr_arg, 8, null_ptr_arg, null_bit_arg, unireg_check_arg,
                  field_name_arg, table_arg, cs) {}
  Field_time(bool maybe_null_arg, const char *field_name_arg,
             struct st_table *table_arg, CHARSET_INFO *cs)
      : Field_str((char *)0, 8, maybe_null_arg ? (uchar *)"" : 0, 0, NONE,
                  field_name_arg, table_arg, cs) {}
...
public:
  Field_datetime(char *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
                 enum utype unireg_check_arg, const char *field_name_arg,
                 struct st_table *table_arg, CHARSET_INFO *cs)
      : Field_str(ptr_arg, 19, null_ptr_arg, null_bit_arg, unireg_check_arg,
                  field_name_arg, table_arg, cs) {}
  Field_datetime(bool maybe_null_arg, const char *field_name_arg,
                 struct st_table *table_arg, CHARSET_INFO *cs)
      : Field_str((char *)0, 19, maybe_null_arg ? (uchar *)"" : 0, 0, NONE,
                  field_name_arg, table_arg, cs) {}
...
public:
  ...
  uint32 length_bytes;
  Field_varstring(char *ptr_arg, uint32 len_arg, uint length_bytes_arg,
  ...
  uint32 sort_length() const {
    return (uint32)field_length +
           (field_charset == &my_charset_bin ? length_bytes : 0);
  }
  int store(const char *to, uint length, CHARSET_INFO *charset);
  int store(longlong nr, bool unsigned_val);
  int store(double nr) { return Field_str::store(nr); } /* QQ: To be deleted */
  ...
  Field *new_key_field(MEM_ROOT *root, struct st_table *new_table,
                       char *new_ptr, uchar *new_null_ptr, uint new_null_bit);
};
...
public:
  ...
  Field_geom(char *ptr_arg, uchar *null_ptr_arg, uint null_bit_arg,
      ...
      : Field_blob(ptr_arg, null_ptr_arg, null_bit_arg, unireg_check_arg,
                   field_name_arg, table_arg, blob_pack_length,
                   &my_charset_bin) {
    geom_type = geom_type_arg;
  }
  Field_geom(uint32 len_arg, bool maybe_null_arg, const char *field_name_arg,
             struct st_table *table_arg, enum geometry_type geom_type_arg)
      : Field_blob(len_arg, maybe_null_arg, field_name_arg, table_arg,
                   &my_charset_bin) {
    geom_type = geom_type_arg;
  }
...
public:
  Field_set(char *ptr_arg, uint32 len_arg, uchar *null_ptr_arg,
      ...
      : Field_enum(ptr_arg, len_arg, null_ptr_arg, null_bit_arg,
                   unireg_check_arg, field_name_arg, table_arg, packlength_arg,
...
Field *make_field(char *ptr, uint32 field_length, uchar *null_pos,
                  uchar null_bit, uint pack_flag, enum_field_types field_type,
                  CHARSET_INFO *cs, Field::geometry_type geom_type,
                  Field::utype unireg_check, TYPELIB *interval,
                  const char *field_name, struct st_table *table);
...
#define f_is_enum(x)                                                           \
  (((x) & (FIELDFLAG_INTERVAL | FIELDFLAG_NUMBER)) == FIELDFLAG_INTERVAL)
#define f_is_bitfield(x)                                                       \
  (((x) & (FIELDFLAG_BITFIELD | FIELDFLAG_NUMBER)) == FIELDFLAG_BITFIELD)
#define f_is_blob(x)                                                           \
  (((x) & (FIELDFLAG_BLOB | FIELDFLAG_NUMBER)) == FIELDFLAG_BLOB)
#define f_is_geom(x)                                                           \
  (((x) & (FIELDFLAG_GEOM | FIELDFLAG_NUMBER)) == FIELDFLAG_GEOM)
