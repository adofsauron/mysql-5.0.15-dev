...
class ha_myisammrg : public handler
{
 ...
 public:
  ...
  {
    return (HA_REC_NOT_IN_SEQ | HA_AUTO_PART_KEY | HA_READ_RND_SAME | HA_NULL_IN_KEY | HA_CAN_INDEX_BLOBS |
            HA_FILE_BASED | HA_CAN_INSERT_DELAYED | HA_ANY_INDEX_MAY_BE_UNIQUE);
  }
  ...
  double scan_time() { return ulonglong2double(data_file_length) / IO_SIZE + file->tables; }
