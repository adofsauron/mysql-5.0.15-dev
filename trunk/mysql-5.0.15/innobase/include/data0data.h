...
void dfield_set_data_noninline(dfield_t *field,           /* in: field */
                               void *data,                /* in: data */
                               ulint len);                /* in: length or UNIV_SQL_NULL */
void *dfield_get_data_noninline(dfield_t *field);         /* in: field */
ulint dfield_get_len_noninline(dfield_t *field);          /* in: field */
ulint dtuple_get_n_fields_noninline(dtuple_t *tuple);     /* in: tuple */
dfield_t *dtuple_get_nth_field_noninline(dtuple_t *tuple, /* in: tuple */
                                         ulint n);        /* in: index of field */

/*************************************************************************
Gets pointer to the type struct of SQL data field. */
UNIV_INLINE
dtype_t *dfield_get_type(
    /*============*/
...
dtuple_t *dtuple_create_for_mysql(
    /*====================*/
...
ibool dtuple_datas_are_ordering_equal(
    /*============================*/
...
ibool dtuple_check_typed_no_assert(
    /*=========================*/
    /* out: TRUE if ok */
    dtuple_t *tuple); /* in: tuple */
#ifdef UNIV_DEBUG
