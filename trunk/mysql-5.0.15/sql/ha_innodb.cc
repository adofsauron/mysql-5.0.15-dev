...
long innobase_mirrored_log_groups, innobase_log_files_in_group, innobase_log_file_size, innobase_log_buffer_size,
    innobase_buffer_pool_awe_mem_mb, innobase_buffer_pool_size, innobase_additional_mem_pool_size,
...
static mysql_byte *innobase_get_key(INNOBASE_SHARE *share, uint *length, my_bool not_used __attribute__((unused)));
...
handlerton innobase_hton = {"InnoDB",
                            SHOW_OPTION_YES,
...
struct show_var_st innodb_status_variables[] = {
    {"buffer_pool_pages_data", (char *)&export_vars.innodb_buffer_pool_pages_data, SHOW_LONG},
    {"buffer_pool_pages_dirty", (char *)&export_vars.innodb_buffer_pool_pages_dirty, SHOW_LONG},
    {"buffer_pool_pages_flushed", (char *)&export_vars.innodb_buffer_pool_pages_flushed, SHOW_LONG},
    {"buffer_pool_pages_free", (char *)&export_vars.innodb_buffer_pool_pages_free, SHOW_LONG},
    {"buffer_pool_pages_latched", (char *)&export_vars.innodb_buffer_pool_pages_latched, SHOW_LONG},
    {"buffer_pool_pages_misc", (char *)&export_vars.innodb_buffer_pool_pages_misc, SHOW_LONG},
    {"buffer_pool_pages_total", (char *)&export_vars.innodb_buffer_pool_pages_total, SHOW_LONG},
    {"buffer_pool_read_ahead_rnd", (char *)&export_vars.innodb_buffer_pool_read_ahead_rnd, SHOW_LONG},
    {"buffer_pool_read_ahead_seq", (char *)&export_vars.innodb_buffer_pool_read_ahead_seq, SHOW_LONG},
    {"buffer_pool_read_requests", (char *)&export_vars.innodb_buffer_pool_read_requests, SHOW_LONG},
    {"buffer_pool_reads", (char *)&export_vars.innodb_buffer_pool_reads, SHOW_LONG},
    {"buffer_pool_wait_free", (char *)&export_vars.innodb_buffer_pool_wait_free, SHOW_LONG},
    {"buffer_pool_write_requests", (char *)&export_vars.innodb_buffer_pool_write_requests, SHOW_LONG},
    {"data_fsyncs", (char *)&export_vars.innodb_data_fsyncs, SHOW_LONG},
    {"data_pending_fsyncs", (char *)&export_vars.innodb_data_pending_fsyncs, SHOW_LONG},
    {"data_pending_reads", (char *)&export_vars.innodb_data_pending_reads, SHOW_LONG},
    {"data_pending_writes", (char *)&export_vars.innodb_data_pending_writes, SHOW_LONG},
    ...
    {"dblwr_pages_written", (char *)&export_vars.innodb_dblwr_pages_written, SHOW_LONG},
    {"dblwr_writes", (char *)&export_vars.innodb_dblwr_writes, SHOW_LONG},
    {"log_waits", (char *)&export_vars.innodb_log_waits, SHOW_LONG},
    {"log_write_requests", (char *)&export_vars.innodb_log_write_requests, SHOW_LONG},
    {"log_writes", (char *)&export_vars.innodb_log_writes, SHOW_LONG},
    {"os_log_fsyncs", (char *)&export_vars.innodb_os_log_fsyncs, SHOW_LONG},
    {"os_log_pending_fsyncs", (char *)&export_vars.innodb_os_log_pending_fsyncs, SHOW_LONG},
    {"os_log_pending_writes", (char *)&export_vars.innodb_os_log_pending_writes, SHOW_LONG},
    {"os_log_written", (char *)&export_vars.innodb_os_log_written, SHOW_LONG},
    ...
    {"row_lock_current_waits", (char *)&export_vars.innodb_row_lock_current_waits, SHOW_LONG},
    {"row_lock_time", (char *)&export_vars.innodb_row_lock_time, SHOW_LONGLONG},
    {"row_lock_time_avg", (char *)&export_vars.innodb_row_lock_time_avg, SHOW_LONG},
    {"row_lock_time_max", (char *)&export_vars.innodb_row_lock_time_max, SHOW_LONG},
...
of an SQL statement. */
inline void innobase_release_stat_resources(
    /*============================*/
...
static int convert_error_code_to_mysql(
    /*========================*/
...
function! */
extern "C" void innobase_mysql_prepare_print_arbitrary_thd(void)
/*============================================*/
{
...
NOTE that /mysql/innobase/lock/lock0lock.c must contain the prototype for this
function! */
extern "C" void innobase_mysql_end_print_arbitrary_thd(void)
/*========================================*/
{
...
this function! */
extern "C" void innobase_mysql_print_thd(
    /*=====================*/
                           ...
                           use the default max length */
{
  ...
  fprintf(f, "MySQL thread id %lu, query id %lu", thd->thread_id, (ulong)thd->query_id);
  if (sctx->host)
  {
    putc(' ', f);
    fputs(sctx->host, f);
...
extern "C" void innobase_get_cset_width(
    /*====================*/
...
extern "C" int innobase_strcasecmp(
    /*================*/
...
NOTE that the exact prototype of this function has to be in
/innobase/dict/dict0dict.c! */
extern "C" void innobase_casedn_str(
    /*================*/
...
extern "C" int innobase_mysql_tmpfile(void)
/*========================*/
/* out: temporary file descriptor, or < 0 on error */
{
...
#ifdef __WIN__
                             O_BINARY | O_TRUNC | O_SEQUENTIAL | O_TEMPORARY | O_SHORT_LIVED |
#endif /* __WIN__ */
  ...
  if (fd >= 0)
  {
    ...
    if (fd2 < 0)
    {
      ...
      my_errno = errno;
      my_error(EE_OUT_OF_FILERESOURCES, MYF(ME_BELL + ME_WAITTANG), filename, my_errno);
    }
...
ha_innobase::ha_innobase(TABLE *table_arg)
    : handler(&innobase_hton, table_arg),
      int_table_flags(HA_REC_NOT_IN_SEQ | HA_NULL_IN_KEY | HA_CAN_INDEX_BLOBS | HA_CAN_SQL_HANDLER |
                      HA_NOT_EXACT_COUNT | HA_PRIMARY_KEY_IN_READ_INDEX | HA_TABLE_SCAN_ON_INDEX),
      last_dup_key((uint)-1),
      start_of_scan(0),
      num_write_row(0)
{
...
prebuilt struct. */
inline int ha_innobase::update_thd(
    /*====================*/
    /* out: 0 or error code */
...
inline void innobase_register_stmt(
    /*===================*/
...
inline void innobase_register_trx_and_stmt(
    /*===========================*/
    THD *thd) /* in: MySQL thd (connection) object */
{
...
my_bool innobase_query_caching_of_table_permitted(
    /*======================================*/
...
extern "C" void innobase_invalidate_query_cache(
    /*============================*/
...
extern "C" int mysql_get_identifier_quote_char(
    /*============================*/
    ...
    ulint namelen)    /* in: length of name */
{
  ...
  return (get_quote_char_for_identifier((THD *)trx->mysql_thd, name, (int)namelen));
}

/**************************************************************************
Determines if the currently running transaction has been interrupted. */
extern "C" ibool trx_is_interrupted(
    /*===============*/
...
extern "C" void *innobase_current_thd(void)
/*======================*/
...
/* out: &innobase_hton, or NULL on error */
{
  ...
  ret = (bool)srv_parse_data_file_paths_and_sizes(
      internal_innobase_data_file_path, &srv_data_file_names, &srv_data_file_sizes, &srv_data_file_is_raw_partition,
      &srv_n_data_files, &srv_auto_extend_last_data_file, &srv_last_file_size_max);
  if (ret == FALSE)
  {
  ...
  ret = (bool)srv_parse_log_group_home_dirs(innobase_log_group_home_dir, &srv_log_group_home_dirs);
  ...
  {
    srv_use_awe = TRUE;
    srv_pool_size = (ulint)(1024 * innobase_buffer_pool_awe_mem_mb);
  ...
  ut_a(DATA_MYSQL_LATIN1_SWEDISH_CHARSET_COLL == my_charset_latin1.number);
  ...
  ut_a(0 == strcmp((char *)my_charset_latin1.name, (char *)"latin1_swedish_ci"));
  ...
  (void)hash_init(&innobase_open_tables, system_charset_info, 32, 0, 0, (hash_get_key)innobase_get_key, 0, 0);
    ...
    trx_t *trx) /* in: transaction handle */
{
  ...
  if (thd && thd->slave_thread)
  {
    ...
    trx->mysql_master_log_file_name = active_mi->rli.group_master_log_name;
    trx->mysql_master_log_pos = ((ib_longlong)active_mi->rli.future_group_master_log_pos);
  }
                            ...
                            up to which we wrote */
{
  ...
  if (thd->variables.sync_replication)
  {
    ...
    {
      trx->repl_wait_binlog_name = (char *)mem_alloc_noninline(FN_REFLEN + 100);
    }
    ...
    THD *thd) /* in: user thread */
{
...
#ifdef HAVE_REPLICATION
  if (thd->variables.sync_replication && trx->repl_wait_binlog_name && innobase_repl_state != 0)
  {
  ...
  try_again:
    ...
    cmp = strcmp(innobase_repl_file_name, trx->repl_wait_binlog_name);
    if (cmp > 0 || (cmp == 0 && innobase_repl_pos >= (my_off_t)trx->repl_wait_binlog_pos))
    {
    ...
    {
      cmp = strcmp(trx->repl_wait_binlog_name, innobase_repl_wait_file_name);
      if (cmp < 0 || (cmp == 0 && (my_off_t)trx->repl_wait_binlog_pos <= innobase_repl_wait_pos))
      {
        /* This thd has an even lower position, let
        us update the minimum info */

        strcpy(innobase_repl_wait_file_name, trx->repl_wait_binlog_name);
    ...
    ret = pthread_cond_timedwait(&innobase_repl_cond, &innobase_repl_cond_mutex, &abstime);
    innobase_repl_n_wait_threads--;
    ...
    if (ret != 0)
    {
      ...
      sql_print_error(
          ...
          thd->variables.sync_replication_timeout, innobase_repl_file_name, (ulong)innobase_repl_pos,
...
int innobase_repl_report_sent_binlog(
    /*=============================*/
    /* out: 0 */
                         ...
                         which we sent the contents to the slave */
{
  ...
  if (innobase_repl_state == 0)
  {
    ut_print_timestamp(stderr);
    sql_print_warning(
        "Switching MySQL synchronous replication on "
  ...
  if (innobase_repl_file_name_inited)
  {
    ...
    if (cmp < 0 || (cmp == 0 && end_offset < innobase_repl_pos))
    {
      ut_print_timestamp(stderr);
      sql_print_error(
          ...
          innobase_repl_file_name, (ulong)innobase_repl_pos, log_file_name, (ulong)end_offset);
    }
  }
  ...
  if (innobase_repl_n_wait_threads > 0)
  {
    ...
    cmp = strcmp(innobase_repl_file_name, innobase_repl_wait_file_name);
    if (cmp > 0 || (cmp == 0 && innobase_repl_pos >= innobase_repl_wait_pos))
    {
    ...
    void *savepoint) /* in: savepoint data */
{
  ...
  error = (int)trx_rollback_to_savepoint_for_mysql(trx, name, &mysql_binlog_cache_pos);
  DBUG_RETURN(convert_error_code_to_mysql(error, NULL));
}
              ...
              whose resources should be free'd */
{
  ...
  if (trx->conc_state != TRX_NOT_STARTED && global_system_variables.log_warnings)
    sql_print_warning(
...
enum row_type ha_innobase::get_row_type() const
/*=============================*/
...
static const char *ha_innobase_exts[] = {".ibd", NullS};

const char **ha_innobase::bas_ext() const
/*========================*/
...
static void normalize_table_name(
    /*=================*/
    ...
    uint test_if_locked) /* in: not used */
{
  ...
  upd_and_key_val_buff_len = table->s->reclength + table->s->max_key_length + MAX_REF_PARTS * 3;
  if (!(mysql_byte *)my_multi_malloc(MYF(MY_WME), &upd_buff, upd_and_key_val_buff_len, &key_val_buff,
                                     upd_and_key_val_buff_len, NullS))
  {
    free_share(share);
  ...
  ib_table = dict_table_get_and_increment_handle_count(norm_name, NULL);
  if (NULL == ib_table)
  {
    ut_print_timestamp(stderr);
    sql_print_error(
  ...
  if (!row_table_got_default_clust_index(ib_table))
  {
    ...
    {
      sql_print_error(
          "Table %s has a primary key in InnoDB data "
          "dictionary, but not in MySQL!",
          name);
    }

    ((row_prebuilt_t *)innobase_prebuilt)->clust_index_was_generated = FALSE;
  ...
  else
  {
    ...
    ((row_prebuilt_t *)innobase_prebuilt)->clust_index_was_generated = TRUE;
...
information in table to track the null bit in record. */
inline void set_field_in_record_to_null(
    /*========================*/
    TABLE *table, /* in: MySQL table object */
    Field *field, /* in: MySQL field object */
    char *record) /* in: a row in MySQL format */
                             ...
                             not UNIV_SQL_NULL */
  {
    ...
    switch (mysql_tp)
    {
      ...
      case MYSQL_TYPE_VARCHAR:
        ...
        ret = charset->coll->strnncollsp(charset, a, a_length, b, b_length, 0);
        if (ret < 0)
        {
          return (-1);
        }
...
inline ulint get_innobase_type_from_mysql_type(
    /*==============================*/
    ...
    Field *field)         /* in: MySQL field */
{
  ...
  if (field->real_type() == FIELD_TYPE_ENUM || field->real_type() == FIELD_TYPE_SET)
  {
  ...
  switch (field->type())
  {
    ...
    case MYSQL_TYPE_VARCHAR:    /* new >= 5.0.3 true VARCHAR */
      ...
      else if (strcmp(field->charset()->name, "latin1_swedish_ci") == 0)
      {
        return (DATA_VARCHAR);
      }
      else
...
storage format. */
inline void innobase_write_to_2_little_endian(
    /*==============================*/
...
storage format. */
inline uint innobase_read_from_2_little_endian(
    /*===============================*/
    /* out: value */
...
uint ha_innobase::store_key_val_for_row(
    /*===============================*/
    ...
    const mysql_byte *record) /* in: row in MySQL format */
{
  ...
  for (; key_part != end; key_part++)
  {
    ...
    else if (mysql_type == FIELD_TYPE_TINY_BLOB || mysql_type == FIELD_TYPE_MEDIUM_BLOB ||
             mysql_type == FIELD_TYPE_BLOB || mysql_type == FIELD_TYPE_LONG_BLOB)
    {
      ...
      blob_data = row_mysql_read_blob_ref(&blob_len, (byte *)(record + (ulint)get_field_offset(table, field)),
      ...
      innobase_write_to_2_little_endian((byte *)buff, (ulint)blob_len);
      buff += 2;
                              ...
                              ROW_MYSQL_REC_FIELDS */
{
  ...
  if (templ_type == ROW_MYSQL_REC_FIELDS)
  {
    ...
    else if (prebuilt->hint_need_to_fetch_extra_cols == ROW_RETRIEVE_PRIMARY_KEY)
    {
  ...
  {
    prebuilt->mysql_template = (mysql_row_templ_t *)mem_alloc_noninline(n_fields * sizeof(mysql_row_templ_t));
  }
  ...
  for (i = 0; i < n_fields; i++)
  {
    ...
    if (UNIV_LIKELY(templ_type == ROW_MYSQL_REC_FIELDS))
    {
      ...
      register const ibool index_contains_field = dict_index_contains_col_or_prefix(index, i);
      ...
      if (fetch_primary_key_cols && dict_table_col_in_clustered_key(index->table, i))
      {
        /* This field is needed in the query */
  ...
  include_field:
    ...
    if (index == clust_index)
    {
      templ->rec_field_no = (index->table->cols + i)->clust_pos;
    }
    else
    {
    ...
    if (field->null_ptr)
    {
      templ->mysql_null_byte_offset = (ulint)((char *)field->null_ptr - (char *)table->record[0]);
    ...
    if (mysql_prefix_len < templ->mysql_col_offset + templ->mysql_col_len)
    {
      mysql_prefix_len = templ->mysql_col_offset + templ->mysql_col_len;
    }
    ...
    {
      templ->mysql_length_bytes = (ulint)(((Field_varstring *)field)->length_bytes);
    }

    templ->charset = dtype_get_charset_coll_noninline(index->table->cols[i].type.prtype);
    templ->mbminlen = index->table->cols[i].type.mbminlen;
    templ->mbmaxlen = index->table->cols[i].type.mbmaxlen;
    templ->is_unsigned = index->table->cols[i].type.prtype & DATA_UNSIGNED;
  ...
  if (index != clust_index && prebuilt->need_to_access_clustered)
  {
    ...
    for (i = 0; i < n_requested_fields; i++)
    {
      ...
      templ->rec_field_no = (index->table->cols + templ->col_no)->clust_pos;
    }
  }
}
    ...
    mysql_byte *record) /* in: a row in MySQL format */
{
  ...
  if (prebuilt->trx != (trx_t *)current_thd->ha_data[innobase_hton.slot])
  {
    sql_print_error(
        "The transaction object for the table handle is at "
        "%p, but for the current thread it is at %p",
        prebuilt->trx, (trx_t *)current_thd->ha_data[innobase_hton.slot]);
    ...
    fputs(
        ...
        stderr);
    ut_print_buf(stderr, ((byte *)(&(current_thd->ha_data[innobase_hton.slot]))) - 100, 200);
    putc('\n', stderr);
    ut_error;
  }
      ...
      num_write_row >= 10000)
  {
    ...
    src_table = lock_get_src_table(prebuilt->trx, prebuilt->table, &mode);
    if (!src_table)
    {
    no_commit:
    ...
    else
    {
      ...
      if (!lock_is_table_exclusive(prebuilt->table, prebuilt->trx))
      {
        goto no_commit;
      }
  ...
  if (error == DB_DUPLICATE_KEY && auto_inc_used &&
      (user_thd->lex->sql_command == SQLCOM_REPLACE || user_thd->lex->sql_command == SQLCOM_REPLACE_SELECT ||
       (user_thd->lex->sql_command == SQLCOM_LOAD && user_thd->lex->duplicates == DUP_REPLACE)))
  {
    auto_inc = table->next_number_field->val_int();
...
static int calc_row_difference(
    /*================*/
    ...
    THD *thd)                 /* in: user thread */
{
  ...
  for (i = 0; i < n_fields; i++)
  {
    ...
    if (field->null_ptr)
    {
      if (field_in_record_is_null(table, field, (char *)old_row))
      {
        o_len = UNIV_SQL_NULL;
      }

      if (field_in_record_is_null(table, field, (char *)new_row))
      {
        n_len = UNIV_SQL_NULL;
      }
    }

    if (o_len != n_len || (o_len != UNIV_SQL_NULL && 0 != memcmp(o_ptr, n_ptr, o_len)))
    {
      ...
      {
        buf = row_mysql_store_col_in_innobase_format(&dfield, (byte *)buf, TRUE, new_mysql_row_col, col_pack_len,
                                                     prebuilt->table->comp);
    ...
    mysql_byte *new_row)       /* in: new row in MySQL format */
{
  ...
  calc_row_difference(uvect, (mysql_byte *)old_row, new_row, table, upd_buff, (ulint)upd_and_key_val_buff_len, prebuilt,
                      user_thd);
...
by InnoDB. */
inline ulint convert_search_mode_to_innobase(
    /*============================*/
    ...
    enum ha_rkey_function find_flag) /* in: search flags from my_base.h */
{
  ...
  if (key_ptr)
  {
    ...
    row_sel_convert_mysql_key_to_innobase(prebuilt->search_tuple, (byte *)key_val_buff, (ulint)upd_and_key_val_buff_len,
                                          index, (byte *)key_ptr, (ulint)key_len, prebuilt->trx);
  }
  else
  {
...
int ha_innobase::index_read_idx(
    /*========================*/
    /* out: error number or 0 */
    mysql_byte *buf,                 /* in/out: buffer for the returned
                                     row */
    ...
    const mysql_byte *record) /* in: row in MySQL format */
{
  ...
  {
    len = store_key_val_for_row(primary_key, (char *)ref, ref_length, record);
  }
  ...
  if (len != ref_length)
  {
    sql_print_error("Stored ref len is %lu, but table ref len is %lu", (ulong)len, (ulong)ref_length);
  }
}

/*********************************************************************
Creates a table definition to an InnoDB database. */
static int create_table_def(
    /*=============*/
    ...
    ibool comp)                     /* in: TRUE=compact record format */
{
  ...
  {
    table->dir_path_of_temp_table = mem_heap_strdup(table->heap, path_of_temp_table);
  }
  ...
  for (i = 0; i < n_cols; i++)
  {
    ...
    dict_mem_table_add_col(
        table, (char *)field->field_name, col_type,
        dtype_form_prtype((ulint)field->type() | nulls_allowed | unsigned_type | binary_type | long_true_varchar,
                          charset_no),
        col_len, 0);
  }
    ...
    uint key_num)           /* in: index number */
{
  ...
  index = dict_mem_index_create((char *)table_name, key->name, 0, ind_type, n_fields);
  ...
  for (i = 0; i < n_fields; i++)
  {
    ...
    for (j = 0; j < form->s->fields; j++)
    {
      ...
      if (0 == innobase_strcasecmp(field->field_name, key_part->field->field_name))
      {
    ...
    if (DATA_BLOB == col_type || (key_part->length < field->pack_length() && field->type() != MYSQL_TYPE_VARCHAR) ||
        (field->type() == MYSQL_TYPE_VARCHAR &&
         key_part->length < field->pack_length() - ((Field_varstring *)field)->length_bytes))
    {
      prefix_len = key_part->length;

      if (col_type == DATA_INT || col_type == DATA_FLOAT || col_type == DATA_DOUBLE || col_type == DATA_DECIMAL)
      {
        sql_print_error(
    ...
    dict_mem_index_add_field(index, (char *)key_part->field->field_name, 0, prefix_len);
  }
...
primary index. */
static int create_clustered_index_when_no_primary(
    /*===================================*/
    trx_t *trx,             /* in: InnoDB transaction handle */
    const char *table_name) /* in: table name */
{
  ...
  index = dict_mem_index_create((char *)table_name, (char *)"GEN_CLUST_INDEX", 0, DICT_CLUSTERED, 0);
                                 ...
                                 create statement string */
{
  ...
  error = create_table_def(trx, form, norm_name, create_info->options & HA_LEX_CREATE_TMP_TABLE ? name2 : NULL,
  ...
  primary_key_no = (table->s->primary_key != MAX_KEY ? (int)table->s->primary_key : -1);
  ...
  if (form->s->keys == 0 || primary_key_no == -1)
  {
    ...
    error = create_clustered_index_when_no_primary(trx, norm_name);
    if (error)
    {
      goto cleanup;
    }
  ...
  if (primary_key_no != -1)
  {
    ...
    first */
    if ((error = create_index(trx, form, norm_name, (uint)primary_key_no)))
    {
      goto cleanup;
    }
  }
  ...
  if (current_thd->query != NULL)
  {
    ...
    if (thd->convert_string(&q, system_charset_info, current_thd->query, current_thd->query_length,
                            current_thd->charset()))
    {
    ...
    error = row_table_add_foreign_constraints(trx, q.str, norm_name, create_info->options & HA_LEX_CREATE_TMP_TABLE);
...
int ha_innobase::discard_or_import_tablespace(
    /*======================================*/
    ...
    my_bool discard) /* in: TRUE if discard, else import */
{
  ...
  ut_a(prebuilt->trx == (trx_t *)current_thd->ha_data[innobase_hton.slot]);
    ...
    const char *name) /* in: table name */
{
  ...
  error = row_drop_table_for_mysql(norm_name, trx, thd->lex->sql_command == SQLCOM_DROP_DB);
                           ...
                           also be 0 */
{
  ...
  KEY *key;
  dict_index_t *index;
  mysql_byte *key_val_buff2 =
      (mysql_byte *)my_malloc(table->s->reclength + table->s->max_key_length + 100, MYF(MY_FAE));
  ulint buff2_len = table->s->reclength + table->s->max_key_length + 100;
  ...
  row_sel_convert_mysql_key_to_innobase(range_start, (byte *)key_val_buff, (ulint)upd_and_key_val_buff_len, index,
                                        (byte *)(min_key ? min_key->key : (const mysql_byte *)0),
                                        (ulint)(min_key ? min_key->length : 0), prebuilt->trx);

  row_sel_convert_mysql_key_to_innobase(range_end, (byte *)key_val_buff2, buff2_len, index,
                                        (byte *)(max_key ? max_key->key : (const mysql_byte *)0),
                                        (ulint)(max_key ? max_key->length : 0), prebuilt->trx);

  mode1 = convert_search_mode_to_innobase(min_key ? min_key->flag : HA_READ_KEY_EXACT);
  mode2 = convert_search_mode_to_innobase(max_key ? max_key->flag : HA_READ_KEY_EXACT);
    ...
    uint flag) /* in: what information MySQL requests */
{
  ...
  if (flag & HA_STATUS_TIME)
  {
    ...
    if (ib_table->space != 0)
    {
      my_snprintf(path, sizeof(path), "%s/%s%s", mysql_data_home, ib_table->name, ".ibd");
  ...
  if (flag & HA_STATUS_VARIABLE)
  {
    ...
    deleted = 0;
    data_file_length = ((ulonglong)ib_table->stat_clustered_index_size) * UNIV_PAGE_SIZE;
    index_file_length = ((ulonglong)ib_table->stat_sum_of_other_index_sizes) * UNIV_PAGE_SIZE;
    delete_length = 0;
    check_time = 0;
      ...
      for (j = 0; j < table->key_info[i].key_parts; j++)
      {
        if (j + 1 > index->n_uniq)
        {
          ...
          sql_print_error(
              ...
              "section 15.1 at "
              "http://www.innodb.com/ibman.html",
              index->name, ib_table->name, (unsigned long)index->n_uniq, j + 1);
          break;
        }
        ...
        {
          rec_per_key = (ha_rows)(records / index->stat_n_diff_key_vals[j + 1]);
        }
        ...
        table->key_info[i].rec_per_key[j] = rec_per_key >= ~(ulong)0 ? ~(ulong)0 : rec_per_key;
      }
  ...
  if (flag & HA_STATUS_ERRKEY)
  {
    ...
    errkey = (unsigned int)row_get_mysql_key_number_for_index((dict_index_t *)trx_get_error_info(prebuilt->trx));
  }
...
char *ha_innobase::update_table_comment(
    /*==============================*/
    ...
    const char *comment) /* in: table comment defined by user */
{
  ...
  if (FILE *file = os_file_create_tmpfile())
  {
    ...
    fprintf(file, "InnoDB free: %lu kB", (ulong)fsp_get_available_space_in_free_extents(prebuilt->table->space));

    dict_print_info_on_foreign_keys(FALSE, file, prebuilt->trx, prebuilt->table);
    flen = ftell(file);
    if (flen < 0)
    {
      flen = 0;
...
MUST be freed with ::free_foreign_key_create_info */
{
  ...
  if (FILE *file = os_file_create_tmpfile())
  {
    ...
    /* output the data to a temporary file */
    dict_print_info_on_foreign_keys(TRUE, file, prebuilt->trx, prebuilt->table);
    prebuilt->trx->op_info = (char *)"";
  ...
  else
  {
    ...
    str = my_strdup("/* Error: cannot display foreign key constraints */", MYF(0));
  }

  return (str);
}

int ha_innobase::get_foreign_key_list(THD *thd, List<FOREIGN_KEY_INFO> *f_key_list)
{
  ...
  while (foreign != NULL)
  {
    ...
    while (tmp_buff[i] != '/') i++;
    tmp_buff += i + 1;
    f_key_info.forein_id = make_lex_string(thd, 0, tmp_buff, (uint)strlen(tmp_buff), 1);
    tmp_buff = foreign->referenced_table_name;
    i = 0;
    while (tmp_buff[i] != '/') i++;
    f_key_info.referenced_db = make_lex_string(thd, 0, tmp_buff, i, 1);
    tmp_buff += i + 1;
    f_key_info.referenced_table = make_lex_string(thd, 0, tmp_buff, (uint)strlen(tmp_buff), 1);
    ...
    f_key_info.constraint_method = make_lex_string(thd, f_key_info.constraint_method, tmp_buff, length, 1);

    FOREIGN_KEY_INFO *pf_key_info = ((FOREIGN_KEY_INFO *)thd->memdup((gptr)&f_key_info, sizeof(FOREIGN_KEY_INFO)));
...
/*=================================*/
{
  ...
  prebuilt->trx->op_info = "determining if there are foreign key constraints";
  row_mysql_lock_data_dictionary(prebuilt->trx);

  can_switch =
      !UT_LIST_GET_FIRST(prebuilt->table->referenced_list) && !UT_LIST_GET_FIRST(prebuilt->table->foreign_list);
...
other flag */
{
  ...
  switch (operation)
  {
    ...
    case HA_EXTRA_RETRIEVE_PRIMARY_KEY:
      ...
      {
        prebuilt->hint_need_to_fetch_extra_cols = ROW_RETRIEVE_PRIMARY_KEY;
      }
      break;
    ...
    thr_lock_type lock_type)
{
  ...
  {
    if (trx->isolation_level != TRX_ISO_SERIALIZABLE && thd->lex->sql_command == SQLCOM_SELECT && lock_type == TL_READ)
    {
    ...
    if (prebuilt->stored_select_lock_type != LOCK_S && prebuilt->stored_select_lock_type != LOCK_X)
    {
      sql_print_error(
...
inline ulint innobase_map_isolation_level(
    /*=========================*/
    ...
    int lock_type) /* in: lock type */
{
  ...
  if (lock_type != F_UNLCK)
  {
    ...
    {
      trx->isolation_level = innobase_map_isolation_level((enum_tx_isolation)thd->variables.tx_isolation);
    }

    if (trx->isolation_level == TRX_ISO_SERIALIZABLE && prebuilt->select_lock_type == LOCK_NONE &&
    ...
    {
      if (thd->in_lock_tables && thd->lex->sql_command != SQLCOM_CALL && thd->variables.innodb_table_locks &&
    ...
    THD *thd) /* in: the MySQL query thread of the caller */
{
  ...
  if (have_innodb != SHOW_OPTION_YES)
  {
    my_message(ER_NOT_SUPPORTED_YET, "Cannot call SHOW INNODB STATUS because skip-innodb is defined", MYF(0));
    DBUG_RETURN(TRUE);
  }
  ...
  if (flen < MAX_STATUS_SIZE)
  {
    ...
    flen = (long)fread(str, 1, flen, srv_monitor_file);
           ...
           trx_list_start + (flen - trx_list_end) < MAX_STATUS_SIZE - sizeof truncated_msg - 1)
  {
...
static INNOBASE_SHARE *get_share(const char *table_name)
{
  ...
  if (!(share = (INNOBASE_SHARE *)hash_search(&innobase_open_tables, (mysql_byte *)table_name, length)))
  {
    if ((share = (INNOBASE_SHARE *)my_malloc(sizeof(*share) + length + 1, MYF(MY_WME | MY_ZEROFILL))))
    {
                                  ...
                                  TL_IGNORE */
{
  ...
  if ((lock_type == TL_READ && thd->in_lock_tables) || (lock_type == TL_READ_HIGH_PRIORITY && thd->in_lock_tables) ||
      lock_type == TL_READ_WITH_SHARED_LOCKS || lock_type == TL_READ_NO_INSERT ||
      (thd->lex->sql_command != SQLCOM_SELECT && lock_type != TL_IGNORE))
  {
    ...
    if (srv_locks_unsafe_for_binlog && prebuilt->trx->isolation_level != TRX_ISO_SERIALIZABLE &&
        (lock_type == TL_READ || lock_type == TL_READ_NO_INSERT) &&
        (thd->lex->sql_command == SQLCOM_INSERT_SELECT || thd->lex->sql_command == SQLCOM_UPDATE))
    {
  ...
  if (lock_type != TL_IGNORE && lock.type == TL_UNLOCK)
  {
    ...
    if ((lock_type >= TL_WRITE_CONCURRENT_INSERT && lock_type <= TL_WRITE) &&
        (!thd->in_lock_tables || thd->lex->sql_command == SQLCOM_CALL) && !thd->tablespace_op &&
        thd->lex->sql_command != SQLCOM_TRUNCATE && thd->lex->sql_command != SQLCOM_CREATE_TABLE)
    {
    ...
    if (lock_type == TL_READ_NO_INSERT && (!thd->in_lock_tables || thd->lex->sql_command == SQLCOM_CALL))
    {
      lock_type = TL_READ;
    }
...
int ha_innobase::innobase_read_and_init_auto_inc(
    /*=========================================*/
    ...
    longlong *ret) /* out: auto-inc value */
{
  ...
  if (error)
  {
    ...
    else
    {
      ...
      sql_print_error(
          "Consistent read of auto-inc column "
          "returned %lu",
          (ulong)error);
      auto_inc = -1;
  ...
  else
  {
    ...
    auto_inc = (longlong)table->found_next_number_field->val_int_offset(table->s->rec_buff_length) + 1;
  }
...
ulonglong ha_innobase::get_auto_increment()
/*=============================*/
...
(deadlock or lock wait timeout) */
{
  ...
  if (error)
  {
    ...
    ut_print_timestamp(stderr);
    sql_print_error("Error %lu in ::get_auto_increment()", (ulong)error);
    return (~(ulonglong)0);
  }
...
bool ha_innobase::get_error_message(int error, String *buf)
{
  ...
  buf->copy(trx->detailed_error, strlen(trx->detailed_error), system_charset_info);
                            ...
                            MySQL key value format */
{
  ...
  for (; key_part != key_part_end; ++key_part)
  {
    ...
    if (mysql_type == FIELD_TYPE_TINY_BLOB || mysql_type == FIELD_TYPE_MEDIUM_BLOB || mysql_type == FIELD_TYPE_BLOB ||
        mysql_type == FIELD_TYPE_LONG_BLOB)
    {
      ...
      ref1 += 2;
      ref2 += 2;
      result = ((Field_blob *)field)->cmp((const char *)ref1, len1, (const char *)ref2, len2);
    }
    else
    {
...
extern "C"
{
  ...
  /*==========================*/
  {
    ...
    if (thd->lex->sql_command == SQLCOM_REPLACE || thd->lex->sql_command == SQLCOM_REPLACE_SELECT ||
        (thd->lex->sql_command == SQLCOM_LOAD && thd->lex->duplicates == DUP_REPLACE))
    {
      return (1);
    }

    if (thd->lex->sql_command == SQLCOM_INSERT && thd->lex->duplicates == DUP_UPDATE)
    {
      return (1);
    }
...
void *innobase_create_cursor_view(void)
/*=============================*/
/* out: Pointer to cursor view or NULL */
{
  return (read_cursor_view_create_for_mysql(check_trx_exists(current_thd)));
}
...
void innobase_close_cursor_view(
    /*=======================*/
    void *curview) /* in: Consistent read view to be closed */
{
  read_cursor_view_close_for_mysql(check_trx_exists(current_thd), (cursor_view_t *)curview);
}
...
void innobase_set_cursor_view(
    /*=====================*/
    void *curview) /* in: Consistent cursor view to be set */
{
  read_cursor_set_for_mysql(check_trx_exists(current_thd), (cursor_view_t *)curview);
}
