...
public:
  ...
  sys_var(const char *name_arg)
      : name(name_arg), after_update(0), no_support_one_shot(1) {}
...
public:
  ...
  sys_var_str(const char *name_arg, sys_check_func check_func_arg,
...
public:
  sys_var_enum(const char *name_arg, uint *value_arg, TYPELIB *typelib,
               sys_after_update_func func)
...
public:
  ulong bit_flag;
  bool reverse;
  sys_var_thd_bit(const char *name_arg, sys_check_func c_func,
                  sys_update_func u_func, ulong bit, bool reverse_arg = 0)
...
public:
  sys_var_collation_connection(const char *name_arg)
...
public:
  sys_var_collation_server(const char *name_arg)
      : sys_var_collation(name_arg) {}
  bool update(THD *thd, set_var *var);
  void set_default(THD *thd, enum_var_type type);
  byte *value_ptr(THD *thd, enum_var_type type, LEX_STRING *base);
...
public:
  sys_var_collation_database(const char *name_arg)
      : sys_var_collation(name_arg) {}
  bool update(THD *thd, set_var *var);
  void set_default(THD *thd, enum_var_type type);
  byte *value_ptr(THD *thd, enum_var_type type, LEX_STRING *base);
...
public:
  ...
  sys_var_readonly(const char *name_arg, enum_var_type type,
      ...
      : sys_var(name_arg), var_type(type), show_type(show_type_arg),
        value_ptr_func(value_ptr_func_arg) {}
  bool update(THD *thd, set_var *var) { return 1; }
  bool check_default(enum_var_type type) { return 1; }
...
public:
  sys_var_thd_time_zone(const char *name_arg) : sys_var_thd(name_arg) {
    no_support_one_shot = 0;
  }
  bool check(THD *thd, set_var *var);
  SHOW_TYPE type() { return SHOW_CHAR; }
