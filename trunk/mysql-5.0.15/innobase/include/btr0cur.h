...
#define BTR_CUR_HASH                      \
  1 /* successful shortcut using the hash \
    index */
#define BTR_CUR_HASH_FAIL                                     \
  2                      /* failure using hash, success using \
                         binary search: the misleading hash   \
                         reference is stored in the field     \
                         hash_node, and might be necessary to \
                         update */
#define BTR_CUR_BINARY 3 /* success using the binary search */
#define BTR_CUR_INSERT_TO_IBUF          \
  4 /* performed the intended insert to \
    the insert buffer */
