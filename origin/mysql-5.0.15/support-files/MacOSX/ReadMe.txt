...
You can install MySQL on Mac OS X 10.2.x (`Jaguar') and up using a Mac
OS X binary package in PKG format instead of the binary tarball
...
startup, you also need to install the MySQL Startup Item. For MySQL
5.0, it is part of the Mac OS X installation disk images as a separate
...
The Startup Item for MySQL 5.0 is installed into
...
`mysqladmin' from the command line. The syntax for `tcsh' is:
