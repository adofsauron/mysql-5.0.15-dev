...
void my_MD5Update(my_MD5_CTX *context,   /* context */
                  ...
                  unsigned int inputLen) /* length of input block */
{
  ...
  MD5_memcpy((POINTER)&context->buffer[idx], (POINTER)&input[i], inputLen - i);
}
...
void my_MD5Final(unsigned char digest[16], /* message digest */
