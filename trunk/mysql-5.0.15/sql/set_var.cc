...
TYPELIB bool_typelib = {array_elements(bool_type_names) - 1, "", bool_type_names, NULL};

const char *delay_key_write_type_names[] = {"OFF", "ON", "ALL", NullS};
TYPELIB delay_key_write_typelib = {array_elements(delay_key_write_type_names) - 1, "", delay_key_write_type_names,
                                   NULL};
...
sys_var_thd_ulong sys_completion_type("completion_type", &SV::completion_type, check_completion_type,
                                      fix_completion_type);
...
sys_var_enum sys_delay_key_write("delay_key_write", &delay_key_write_options, &delay_key_write_typelib,
                                 fix_delay_key_write);
...
sys_var_str sys_ft_boolean_syntax("ft_boolean_syntax", sys_check_ftb_syntax, sys_update_ftb_syntax,
                                  sys_default_ftb_syntax, ft_boolean_syntax);
...
sys_var_thd_bool sys_sql_low_priority_updates("sql_low_priority_updates", &SV::low_priority_updates,
...
sys_var_thd_ulong sys_max_insert_delayed_threads("max_insert_delayed_threads", &SV::max_insert_delayed_threads,
                                                 check_max_delayed_threads, fix_max_connections);
sys_var_thd_ulong sys_max_delayed_threads("max_delayed_threads", &SV::max_insert_delayed_threads,
                                          check_max_delayed_threads, fix_max_connections);
...
sys_var_thd_enum sys_myisam_stats_method("myisam_stats_method", &SV::myisam_stats_method, &myisam_stats_method_typelib,
                                         NULL);
...
sys_var_bool_ptr sys_relay_log_purge("relay_log_purge", &relay_log_purge);
#endif
...
sys_var_thd_ulong sys_query_alloc_block_size("query_alloc_block_size", &SV::query_alloc_block_size, 0,
                                             fix_thd_mem_root);
sys_var_thd_ulong sys_query_prealloc_size("query_prealloc_size", &SV::query_prealloc_size, 0, fix_thd_mem_root);
sys_var_thd_ulong sys_trans_alloc_block_size("transaction_alloc_block_size", &SV::trans_alloc_block_size, 0,
                                             fix_trans_mem_root);
sys_var_thd_ulong sys_trans_prealloc_size("transaction_prealloc_size", &SV::trans_prealloc_size, 0, fix_trans_mem_root);

#ifdef HAVE_QUERY_CACHE
sys_var_long_ptr sys_query_cache_limit("query_cache_limit", &query_cache.query_cache_limit);
sys_var_long_ptr sys_query_cache_min_res_unit("query_cache_min_res_unit", &query_cache_min_res_unit,
                                              fix_query_cache_min_res_unit);
sys_var_thd_enum sys_query_cache_type("query_cache_type", &SV::query_cache_type, &query_cache_type_typelib);
sys_var_thd_bool sys_query_cache_wlock_invalidate("query_cache_wlock_invalidate", &SV::query_cache_wlock_invalidate);
...
#ifdef HAVE_REPLICATION
sys_var_long_ptr sys_slave_net_timeout("slave_net_timeout", &slave_net_timeout);
sys_var_long_ptr sys_slave_trans_retries("slave_transaction_retries", &slave_trans_retries);
#endif
...
sys_var_thd_ulong sys_sync_replication("sync_replication", &SV::sync_replication);
sys_var_thd_ulong sys_sync_replication_slave_id("sync_replication_slave_id", &SV::sync_replication_slave_id);
sys_var_thd_ulong sys_sync_replication_timeout("sync_replication_timeout", &SV::sync_replication_timeout);
#endif
sys_var_bool_ptr sys_sync_frm("sync_frm", &opt_sync_frm);
sys_var_long_ptr sys_table_cache_size("table_cache", &table_cache_size);
...
sys_var_thd_enum sys_tx_isolation("tx_isolation", &SV::tx_isolation, &tx_isolation_typelib, fix_tx_isolation);
...
#ifdef HAVE_INNOBASE_DB
sys_var_long_ptr sys_innodb_fast_shutdown("innodb_fast_shutdown", &innobase_fast_shutdown);
sys_var_long_ptr sys_innodb_max_dirty_pages_pct("innodb_max_dirty_pages_pct", &srv_max_buf_pool_modified_pct);
sys_var_long_ptr sys_innodb_max_purge_lag("innodb_max_purge_lag", &srv_max_purge_lag);
sys_var_thd_bool sys_innodb_table_locks("innodb_table_locks", &SV::innodb_table_locks);
sys_var_thd_bool sys_innodb_support_xa("innodb_support_xa", &SV::innodb_support_xa);
sys_var_long_ptr sys_innodb_autoextend_increment("innodb_autoextend_increment", &srv_auto_extend_increment);
...
sys_var_long_ptr sys_innodb_thread_sleep_delay("innodb_thread_sleep_delay", &srv_thread_sleep_delay);
sys_var_long_ptr sys_innodb_thread_concurrency("innodb_thread_concurrency", &srv_thread_concurrency);
sys_var_long_ptr sys_innodb_commit_concurrency("innodb_commit_concurrency", &srv_commit_concurrency);
#endif
...
sys_var_thd_ulong sys_ndb_autoincrement_prefetch_sz("ndb_autoincrement_prefetch_sz",
...
static sys_var_thd_bit sys_log_off("sql_log_off", 0, set_option_bit, OPTION_LOG_OFF);
static sys_var_thd_bit sys_log_update("sql_log_update", check_log_update, set_log_update, OPTION_UPDATE_LOG);
static sys_var_thd_bit sys_log_binlog("sql_log_bin", check_log_update, set_log_bin, OPTION_BIN_LOG);
...
sys_var_readonly sys_have_innodb("have_innodb", OPT_GLOBAL, SHOW_CHAR, get_have_innodb);
...
struct show_var_st init_vars[] = {
    ...
    {sys_engine_condition_pushdown.name, (char *)&sys_engine_condition_pushdown, SHOW_SYS},
    ...
    {sys_key_cache_age_threshold.name, (char *)&sys_key_cache_age_threshold, SHOW_SYS},
    {sys_key_cache_block_size.name, (char *)&sys_key_cache_block_size, SHOW_SYS},
    {sys_key_cache_division_limit.name, (char *)&sys_key_cache_division_limit, SHOW_SYS},
    ...
    {sys_max_insert_delayed_threads.name, (char *)&sys_max_insert_delayed_threads, SHOW_SYS},
    {sys_max_join_size.name, (char *)&sys_max_join_size, SHOW_SYS},
    {sys_max_length_for_sort_data.name, (char *)&sys_max_length_for_sort_data, SHOW_SYS},
    ...
    {sys_myisam_max_sort_file_size.name, (char *)&sys_myisam_max_sort_file_size, SHOW_SYS},
    {"myisam_recover_options", (char *)&myisam_recover_options_str, SHOW_CHAR_PTR},
    {sys_myisam_repair_threads.name, (char *)&sys_myisam_repair_threads, SHOW_SYS},
...
#endif
#ifdef HAVE_NDBCLUSTER_DB
    {sys_ndb_autoincrement_prefetch_sz.name, (char *)&sys_ndb_autoincrement_prefetch_sz, SHOW_SYS},
    ...
    {sys_optimizer_prune_level.name, (char *)&sys_optimizer_prune_level, SHOW_SYS},
    {sys_optimizer_search_depth.name, (char *)&sys_optimizer_search_depth, SHOW_SYS},
    {"pid_file", (char *)pidfile_name, SHOW_CHAR},
    {"port", (char *)&mysqld_port, SHOW_INT},
    {sys_preload_buff_size.name, (char *)&sys_preload_buff_size, SHOW_SYS},
    {"protocol_version", (char *)&protocol_version, SHOW_INT},
    {sys_query_alloc_block_size.name, (char *)&sys_query_alloc_block_size, SHOW_SYS},
#ifdef HAVE_QUERY_CACHE
    {sys_query_cache_limit.name, (char *)&sys_query_cache_limit, SHOW_SYS},
    {sys_query_cache_min_res_unit.name, (char *)&sys_query_cache_min_res_unit, SHOW_SYS},
    {sys_query_cache_size.name, (char *)&sys_query_cache_size, SHOW_SYS},
    {sys_query_cache_type.name, (char *)&sys_query_cache_type, SHOW_SYS},
    {sys_query_cache_wlock_invalidate.name, (char *)&sys_query_cache_wlock_invalidate, SHOW_SYS},
#endif /* HAVE_QUERY_CACHE */
    {sys_query_prealloc_size.name, (char *)&sys_query_prealloc_size, SHOW_SYS},
    {sys_range_alloc_block_size.name, (char *)&sys_range_alloc_block_size, SHOW_SYS},
...
#ifdef HAVE_REPLICATION
    {sys_slave_compressed_protocol.name, (char *)&sys_slave_compressed_protocol, SHOW_SYS},
    ...
    {sys_trans_alloc_block_size.name, (char *)&sys_trans_alloc_block_size, SHOW_SYS},
    {sys_trans_prealloc_size.name, (char *)&sys_trans_prealloc_size, SHOW_SYS},
    {sys_tx_isolation.name, (char *)&sys_tx_isolation, SHOW_SYS},
    {sys_updatable_views_with_limit.name, (char *)&sys_updatable_views_with_limit, SHOW_SYS},
...
{
  int res;
  if (!check_func) return 0;

  if ((res = (*check_func)(thd, var)) < 0) my_error(ER_WRONG_VALUE_FOR_VAR, MYF(0), name, var->value->str_value.ptr());
  return res;
}
...
bool update_sys_var_str(sys_var_str *var_str, rw_lock_t *var_mutex, set_var *var)
{
  ...
  if (!old_value) old_value = (char *)"";
  if (!(res = my_strdup_with_length((byte *)old_value, new_length, MYF(0)))) return 1;
  /*
...
static int sys_check_ftb_syntax(THD *thd, set_var *var)
{
  if (thd->security_ctx->master_access & SUPER_ACL)
    return (ft_boolean_check_syntax_string((byte *)var->value->str_value.c_ptr()) ? -1 : 0);
  else
  {
...
static bool sys_update_ftb_syntax(THD *thd, set_var *var)
{
  strmake(ft_boolean_syntax, var->value->str_value.c_ptr(), sizeof(ft_boolean_syntax) - 1);
  return 0;
}

static void sys_default_ftb_syntax(THD *thd, enum_var_type type)
{
  strmake(ft_boolean_syntax, def_ft_boolean_syntax, sizeof(ft_boolean_syntax) - 1);
}
...
{
  if (type != OPT_GLOBAL)
    thd->update_lock_default = (thd->variables.low_priority_updates ? TL_WRITE_LOW_PRIORITY : TL_WRITE);
}
...
static void fix_tx_isolation(THD *thd, enum_var_type type)
{
  if (type == OPT_SESSION) thd->session_tx_isolation = ((enum_tx_isolation)thd->variables.tx_isolation);
}
...
static void fix_net_read_timeout(THD *thd, enum_var_type type)
{
  if (type != OPT_GLOBAL) thd->net.read_timeout = thd->variables.net_read_timeout;
}

static void fix_net_write_timeout(THD *thd, enum_var_type type)
{
  if (type != OPT_GLOBAL) thd->net.write_timeout = thd->variables.net_write_timeout;
}

static void fix_net_retry_count(THD *thd, enum_var_type type)
{
  if (type != OPT_GLOBAL) thd->net.retry_count = thd->variables.net_retry_count;
}
...
static void fix_query_cache_size(THD *thd, enum_var_type type)
{
  ...
  if (requested != query_cache_size)
    push_warning_printf(current_thd, MYSQL_ERROR::WARN_LEVEL_WARN, ER_WARN_QC_RESIZE, ER(ER_WARN_QC_RESIZE), requested,
                        query_cache_size);
#endif
}
...
static void fix_max_binlog_size(THD *thd, enum_var_type type)
{
  ...
  DBUG_PRINT("info", ("max_binlog_size=%lu max_relay_log_size=%lu", max_binlog_size, max_relay_log_size));
  mysql_bin_log.set_max_size(max_binlog_size);
#ifdef HAVE_REPLICATION
  if (!max_relay_log_size) active_mi->rli.relay_log.set_max_size(max_binlog_size);
#endif
  DBUG_VOID_RETURN;
}
...
static void fix_max_relay_log_size(THD *thd, enum_var_type type)
{
  ...
  DBUG_PRINT("info", ("max_binlog_size=%lu max_relay_log_size=%lu", max_binlog_size, max_relay_log_size));
#ifdef HAVE_REPLICATION
  active_mi->rli.relay_log.set_max_size(max_relay_log_size ? max_relay_log_size : max_binlog_size);
#endif
  DBUG_VOID_RETURN;
}
...
{
  longlong val = var->value->val_int();
  if (var->type != OPT_GLOBAL && val != 0 && val != (longlong)global_system_variables.max_insert_delayed_threads)
  {
    char buf[64];
    my_error(ER_WRONG_VALUE_FOR_VAR, MYF(0), var->var->name, llstr(val, buf));
    return 1;
...
static void fix_max_connections(THD *thd, enum_var_type type)
{
  ...
  resize_thr_alarm(max_connections + global_system_variables.max_insert_delayed_threads + 10);
#endif
}
...
{
  if (type != OPT_GLOBAL)
    reset_root_defaults(thd->mem_root, thd->variables.query_alloc_block_size, thd->variables.query_prealloc_size);
}
...
static void fix_trans_mem_root(THD *thd, enum_var_type type)
{
  ...
  if (type != OPT_GLOBAL)
    reset_root_defaults(&thd->transaction.mem_root, thd->variables.trans_alloc_block_size,
                        thd->variables.trans_prealloc_size);
#endif
}

static void fix_server_id(THD *thd, enum_var_type type) { server_id_supplied = 1; }
...
void sys_var_long_ptr::set_default(THD *thd, enum_var_type type) { *value = (ulong)option_limits->def_value; }
...
void sys_var_bool_ptr::set_default(THD *thd, enum_var_type type) { *value = (my_bool)option_limits->def_value; }
...
{
  return (sys_var_thd::check(thd, var) || (check_func && (*check_func)(thd, var)));
}
...
bool sys_var_thd_ulong::update(THD *thd, set_var *var)
{
  ...
  if ((ulong)tmp > max_system_variables.*offset) tmp = max_system_variables.*offset;
  ...
  if (option_limits) tmp = (ulong)getopt_ull_limit_value(tmp, option_limits);
...
byte *sys_var_thd_ulong::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type == OPT_GLOBAL) return (byte *)&(global_system_variables.*offset);
...
bool sys_var_thd_ha_rows::update(THD *thd, set_var *var)
{
  ...
  /* Don't use bigger value than given with --maximum-variable-name=.. */
  if ((ha_rows)tmp > max_system_variables.*offset) tmp = max_system_variables.*offset;

  if (option_limits) tmp = (ha_rows)getopt_ull_limit_value(tmp, option_limits);
  if (var->type == OPT_GLOBAL)
  {
...
byte *sys_var_thd_ha_rows::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type == OPT_GLOBAL) return (byte *)&(global_system_variables.*offset);
  return (byte *)&(thd->variables.*offset);
}
...
bool sys_var_thd_ulonglong::update(THD *thd, set_var *var)
{
  ...
  if (tmp > max_system_variables.*offset) tmp = max_system_variables.*offset;

  if (option_limits) tmp = getopt_ull_limit_value(tmp, option_limits);
  if (var->type == OPT_GLOBAL)
  {
    /* Lock is needed to make things safe on 32 bit systems */
    pthread_mutex_lock(&LOCK_global_system_variables);
...
byte *sys_var_thd_ulonglong::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type == OPT_GLOBAL) return (byte *)&(global_system_variables.*offset);
  return (byte *)&(thd->variables.*offset);
}
...
byte *sys_var_thd_bool::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type == OPT_GLOBAL) return (byte *)&(global_system_variables.*offset);
  return (byte *)&(thd->variables.*offset);
}
...
bool sys_var::check_enum(THD *thd, set_var *var, TYPELIB *enum_names)
{
  ...
  if (var->value->result_type() == STRING_RESULT)
  {
    if (!(res = var->value->val_str(&str)) ||
        ((long)(var->save_result.ulong_value = (ulong)find_type(enum_names, res->ptr(), res->length(), 1) - 1)) < 0)
    {
...
bool sys_var::check_set(THD *thd, set_var *var, TYPELIB *enum_names)
{
  ...
  if (var->value->result_type() == STRING_RESULT)
  {
    ...
    var->save_result.ulong_value =
        ((ulong)find_set(enum_names, res->c_ptr(), res->length(), NULL, &error, &error_len, &not_used));
    if (error_len)
    {
...
Item *sys_var::item(THD *thd, enum_var_type var_type, LEX_STRING *base)
{
  if (check_type(var_type))
  {
    ...
    {
      my_error(ER_INCORRECT_GLOBAL_LOCAL_VAR, MYF(0), name, var_type == OPT_GLOBAL ? "SESSION" : "GLOBAL");
      return 0;
    }
  ...
  switch (type())
  {
    ...
    case SHOW_CHAR:
    {
      ...
      if (str)
        tmp = new Item_string(str, strlen(str), system_charset_info, DERIVATION_SYSCONST);
      else
      {
        tmp = new Item_null();
...
byte *sys_var_thd_enum::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  ulong tmp = ((type == OPT_GLOBAL) ? global_system_variables.*offset : thd->variables.*offset);
  return (byte *)enum_names->type_names[tmp];
}

bool sys_var_thd_bit::check(THD *thd, set_var *var)
{
  return (check_enum(thd, var, &bool_typelib) || (check_func && (*check_func)(thd, var)));
}
...
byte *sys_var_thd_bit::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  /*
    If reverse is 0 (default) return 1 if bit is set.
    If reverse is 1, return 0 if bit is set
  */
  thd->sys_var_tmp.my_bool_value = ((thd->options & bit_flag) ? !reverse : reverse);
  return (byte *)&thd->sys_var_tmp.my_bool_value;
}

/* Update a date_time format variable based on given value */

void sys_var_thd_date_time_format::update2(THD *thd, enum_var_type type, DATE_TIME_FORMAT *new_value)
{
  DATE_TIME_FORMAT *old;
  DBUG_ENTER("sys_var_date_time_format::update2");
  DBUG_DUMP("positions", (char *)new_value->positions, sizeof(new_value->positions));
...
bool sys_var_thd_date_time_format::update(THD *thd, set_var *var)
{
  ...
  new_value = date_time_format_copy((THD *)0, var->save_result.date_time_format);
  if (!new_value) return 1;            // Out of memory
...
bool sys_var_thd_date_time_format::check(THD *thd, set_var *var)
{
  ...
  if (!(res = var->value->val_str(&str))) res = &my_empty_string;

  if (!(format = date_time_format_make(date_time_type, res->ptr(), res->length())))
  {
...
byte *sys_var_thd_date_time_format::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type == OPT_GLOBAL)
  {
    char *res;
    ...
    */
    res = thd->strmake((global_system_variables.*offset)->format.str, (global_system_variables.*offset)->format.length);
    return (byte *)res;
  }
...
byte *sys_var_character_set::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
...
byte *sys_var_collation_connection::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_connection : thd->variables.collation_connection);
...
byte *sys_var_collation_database::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_database : thd->variables.collation_database);
  return cs ? (byte *)cs->name : (byte *)"NULL";
}
...
byte *sys_var_collation_server::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  CHARSET_INFO *cs =
      ((type == OPT_GLOBAL) ? global_system_variables.collation_server : thd->variables.collation_server);
  return cs ? (byte *)cs->name : (byte *)"NULL";
}
...
KEY_CACHE *get_key_cache(LEX_STRING *cache_name)
{
  ...
  return ((KEY_CACHE *)find_named(&key_caches, cache_name->str, cache_name->length, 0));
}

byte *sys_var_key_cache_param::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
...
bool sys_var_key_buffer_size::update(THD *thd, set_var *var)
{
  ...
  */
  if (key_cache->in_init) goto end;

  if (!tmp)  // Zero size means delete
  {
    if (key_cache == dflt_key_cache)
    {
      push_warning_printf(thd, MYSQL_ERROR::WARN_LEVEL_WARN, ER_WARN_CANT_DROP_DEFAULT_KEYCACHE,
    ...
    if (key_cache->key_cache_inited)  // If initied
    {
      ...
      */
      NAMED_LIST *list;
      key_cache = (KEY_CACHE *)find_named(&key_caches, base_name->str, base_name->length, &list);
      key_cache->in_init = 1;
      pthread_mutex_unlock(&LOCK_global_system_variables);
  ...
  key_cache->param_buff_size = (ulonglong)getopt_ull_limit_value(tmp, option_limits);
...
bool sys_var_key_cache_long::update(THD *thd, set_var *var)
{
  ...
  if (!key_cache && !(key_cache = create_key_cache(base_name->str, base_name->length)))
  {
    error = 1;
    goto end;
  }
  ...
  *((ulong *)(((char *)key_cache) + offset)) = (ulong)getopt_ull_limit_value(tmp, option_limits);
...
int set_var_collation_client::check(THD *thd) { return 0; }
...
void sys_var_timestamp::set_default(THD *thd, enum_var_type type) { thd->user_time = 0; }

byte *sys_var_timestamp::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
...
byte *sys_var_last_insert_id::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
...
byte *sys_var_insert_id::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
...
bool sys_var_thd_time_zone::check(THD *thd, set_var *var)
{
  ...
  if (!(var->save_result.time_zone = my_tz_find(res, thd->lex->time_zone_tables_used)))
  {
...
byte *sys_var_thd_time_zone::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  /*
...
void sys_var_thd_time_zone::set_default(THD *thd, enum_var_type type)
{
  ...
  if (type == OPT_GLOBAL)
  {
    if (default_tz_name)
    {
      ...
      */
      global_system_variables.time_zone = my_tz_find(&str, thd->lex->time_zone_tables_used);
    }
    else
...
byte *sys_var_max_user_conn::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  if (type != OPT_GLOBAL && thd->user_connect && thd->user_connect->user_resources.user_conn)
...
static bool set_log_update(THD *thd, set_var *var)
{
  ...
  */
  ...
  {
    ((sys_var_thd_bit *)var->var)->bit_flag |= (OPTION_BIN_LOG | OPTION_UPDATE_LOG);
    push_warning(thd, MYSQL_ERROR::WARN_LEVEL_NOTE, ER_UPDATE_LOG_DEPRECATED_TRANSLATED,
                 ER(ER_UPDATE_LOG_DEPRECATED_TRANSLATED));
  }
  else
    push_warning(thd, MYSQL_ERROR::WARN_LEVEL_NOTE, ER_UPDATE_LOG_DEPRECATED_IGNORED,
...
static bool set_log_bin(THD *thd, set_var *var)
{
  if (opt_sql_bin_update) ((sys_var_thd_bit *)var->var)->bit_flag |= (OPTION_BIN_LOG | OPTION_UPDATE_LOG);
  set_option_bit(thd, var);
  return 0;
}
...
static byte *get_warning_count(THD *thd)
{
  thd->sys_var_tmp.long_value =
      (thd->warn_count[(uint)MYSQL_ERROR::WARN_LEVEL_NOTE] + thd->warn_count[(uint)MYSQL_ERROR::WARN_LEVEL_WARN]);
  return (byte *)&thd->sys_var_tmp.long_value;
}

static byte *get_error_count(THD *thd)
{
  thd->sys_var_tmp.long_value = thd->warn_count[(uint)MYSQL_ERROR::WARN_LEVEL_ERROR];
  return (byte *)&thd->sys_var_tmp.long_value;
}

static byte *get_have_innodb(THD *thd) { return (byte *)show_comp_option_name[have_innodb]; }
...
void set_var_init()
{
  hash_init(&system_variable_hash, system_charset_info, array_elements(sys_variables), 0, 0,
            (hash_get_key)get_sys_var_length, 0, 0);
  sys_var **var, **end;
  for (var = sys_variables, end = sys_variables + array_elements(sys_variables); var < end; var++)
  {
...
void set_var_free() { hash_free(&system_variable_hash); }
...
{
  sys_var *var = (sys_var *)hash_search(&system_variable_hash, (byte *)str, length ? length : strlen(str));
  if (!var) my_error(ER_UNKNOWN_SYSTEM_VARIABLE, MYF(0), (char *)str);
  return var;
}
...
bool not_all_support_one_shot(List<set_var_base> *var_list)
{
  ...
  while ((var = it++))
  {
    if (var->no_support_one_shot()) return 1;
  }
  return 0;
}
...
int set_var::check(THD *thd)
{
  ...
  if ((type == OPT_GLOBAL && check_global_access(thd, SUPER_ACL))) return 1;
  ...
  if ((!value->fixed && value->fix_fields(thd, &value)) || value->check_cols(1)) return -1;
...
int set_var::light_check(THD *thd)
{
  ...
  if (value && ((!value->fixed && value->fix_fields(thd, &value)) || value->check_cols(1))) return -1;
  return 0;
}
...
int set_var::update(THD *thd)
{
  ...
  if (var->after_update) (*var->after_update)(thd, type);
  return 0;
}
...
int set_var_user::check(THD *thd)
{
  ...
  */
  return (user_var_item->fix_fields(thd, (Item **)0) || user_var_item->check()) ? -1 : 0;
}
...
int set_var_password::check(THD *thd)
{
  ...
  return check_change_password(thd, user->host.str, user->user.str, password, strlen(password)) ? 1 : 0;
#else
  return 0;
#endif
}
...
bool sys_var_thd_storage_engine::check(THD *thd, set_var *var)
{
  ...
  if (var->value->result_type() == STRING_RESULT)
  {
    ...
    if (!(res = var->value->val_str(&str)) ||
        !(var->save_result.ulong_value = (ulong)(db_type = ha_resolve_by_name(res->ptr(), res->length()))) ||
...
byte *sys_var_thd_storage_engine::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  ulong val;
  val = ((type == OPT_GLOBAL) ? global_system_variables.*offset : thd->variables.*offset);
...
byte *sys_var_thd_sql_mode::symbolic_mode_representation(THD *thd, ulong val, ulong *len)
{
  char buff[256];
  ...
  for (uint i = 0; val; val >>= 1, i++)
  {
    if (val & 1)
    {
      tmp.append(sql_mode_typelib.type_names[i], sql_mode_typelib.type_lengths[i]);
      tmp.append(',');
    }
  }

  if ((length = tmp.length())) length--;
  *len = length;
  return (byte *)thd->strmake(tmp.ptr(), length);
}

byte *sys_var_thd_sql_mode::value_ptr(THD *thd, enum_var_type type, LEX_STRING *base)
{
  ulong val = ((type == OPT_GLOBAL) ? global_system_variables.*offset : thd->variables.*offset);
  ulong length_unused;
...
ulong fix_sql_mode(ulong sql_mode)
{
  ...
  */
  ...
  {
    sql_mode |= (MODE_REAL_AS_FLOAT | MODE_PIPES_AS_CONCAT | MODE_ANSI_QUOTES | MODE_IGNORE_SPACE);
    /*
  ...
  if (sql_mode & MODE_ORACLE)
    sql_mode |= (MODE_PIPES_AS_CONCAT | MODE_ANSI_QUOTES | MODE_IGNORE_SPACE | MODE_NO_KEY_OPTIONS |
                 MODE_NO_TABLE_OPTIONS | MODE_NO_FIELD_OPTIONS | MODE_NO_AUTO_CREATE_USER);
  if (sql_mode & MODE_MSSQL)
    sql_mode |= (MODE_PIPES_AS_CONCAT | MODE_ANSI_QUOTES | MODE_IGNORE_SPACE | MODE_NO_KEY_OPTIONS |
                 MODE_NO_TABLE_OPTIONS | MODE_NO_FIELD_OPTIONS);
  ...
  if (sql_mode & MODE_MAXDB)
    sql_mode |= (MODE_PIPES_AS_CONCAT | MODE_ANSI_QUOTES | MODE_IGNORE_SPACE | MODE_NO_KEY_OPTIONS |
                 MODE_NO_TABLE_OPTIONS | MODE_NO_FIELD_OPTIONS | MODE_NO_AUTO_CREATE_USER);
  if (sql_mode & MODE_MYSQL40) sql_mode |= MODE_NO_FIELD_OPTIONS | MODE_HIGH_NOT_PRECEDENCE;
  if (sql_mode & MODE_MYSQL323) sql_mode |= MODE_NO_FIELD_OPTIONS | MODE_HIGH_NOT_PRECEDENCE;
  if (sql_mode & MODE_TRADITIONAL)
    sql_mode |= (MODE_STRICT_TRANS_TABLES | MODE_STRICT_ALL_TABLES | MODE_NO_ZERO_IN_DATE | MODE_NO_ZERO_DATE |
...
static KEY_CACHE *create_key_cache(const char *name, uint length)
{
  ...
  if ((key_cache = (KEY_CACHE *)my_malloc(sizeof(KEY_CACHE), MYF(MY_ZEROFILL | MY_WME))))
  {
...
KEY_CACHE *get_or_create_key_cache(const char *name, uint length)
{
  ...
  pthread_mutex_lock(&LOCK_global_system_variables);
  if (!(key_cache = get_key_cache(&key_cache_name))) key_cache = create_key_cache(name, length);
  pthread_mutex_unlock(&LOCK_global_system_variables);
  return key_cache;
}
