...
protected:
  uint multiply;
  uint (*converter)(CHARSET_INFO *cs, char *src, uint srclen, char *dst,
                    uint dstlen);
  String tmp_value;
...
public:
  ...
  void fix_length_and_dec() {
    ...
    max_length =
        args[0]->max_length + (args[0]->max_length - args[0]->decimals) / 3;
  }
