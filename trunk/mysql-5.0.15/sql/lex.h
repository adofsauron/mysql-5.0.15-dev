...
static SYMBOL symbols[] = { { "&&", SYM(AND_AND_SYM) }, { "<", SYM(LT) },
                            { "<=", SYM(LE) }, { "<>", SYM(NE) },
                            { "!=", SYM(NE) }, { "=", SYM(EQ) },
                            { ">", SYM(GT_SYM) }, { ">=", SYM(GE) },
                            { "<<", SYM(SHIFT_LEFT) },
                            ...
                            { "AND", SYM(AND_SYM) }, { "ANY", SYM(ANY_SYM) },
                            { "AS", SYM(AS) }, { "ASC", SYM(ASC) },
                            { "ASCII", SYM(ASCII_SYM) },
                            ...
                            { "BIT", SYM(BIT_SYM) }, { "BLOB", SYM(BLOB_SYM) },
                            { "BOOL", SYM(BOOL_SYM) },
                            { "BOOLEAN", SYM(BOOLEAN_SYM) },
                            { "BOTH", SYM(BOTH) }, { "BTREE", SYM(BTREE_SYM) },
                            { "BY", SYM(BY) }, { "BYTE", SYM(BYTE_SYM) },
                            { "CACHE", SYM(CACHE_SYM) },
                            { "CALL", SYM(CALL_SYM) },
                            { "CASCADE", SYM(CASCADE) },
                            ...
                            { "CREATE", SYM(CREATE) }, { "CROSS", SYM(CROSS) },
                            { "CUBE", SYM(CUBE_SYM) },
                            ...
                            { "DISTINCTROW",
                              SYM(DISTINCT) }, /* Access likes this */
                            { "DIV", SYM(DIV_SYM) },
                            { "DO", SYM(DO_SYM) },
                            ...
                            { "EACH", SYM(EACH_SYM) }, { "ELSE", SYM(ELSE) },
                            { "ELSEIF", SYM(ELSEIF_SYM) },
                            { "ENABLE", SYM(ENABLE_SYM) },
                            { "ENCLOSED", SYM(ENCLOSED) }, { "END", SYM(END) },
                            { "ENGINE", SYM(ENGINE_SYM) },
                            { "ENGINES", SYM(ENGINES_SYM) },
                            { "ENUM", SYM(ENUM) }, { "ERRORS", SYM(ERRORS) },
                            ...
                            { "GOTO", SYM(GOTO_SYM) },
#endif
                            { "GRANT", SYM(GRANT) }, { "GRANTS", SYM(GRANTS) },
                            { "GROUP", SYM(GROUP) },
                            ...
                            { "IF", SYM(IF) }, { "IGNORE", SYM(IGNORE_SYM) },
                            { "IMPORT", SYM(IMPORT) }, { "IN", SYM(IN_SYM) },
                            { "INDEX", SYM(INDEX_SYM) },
                            { "INDEXES", SYM(INDEXES) },
                            { "INFILE", SYM(INFILE) },
                            { "INNER", SYM(INNER_SYM) },
                            ...
                            { "INT", SYM(INT_SYM) }, { "INT1", SYM(TINYINT) },
                            { "INT2", SYM(SMALLINT) },
                            { "INT3", SYM(MEDIUMINT) },
                            { "INT4", SYM(INT_SYM) }, { "INT8", SYM(BIGINT) },
                            { "INTEGER", SYM(INT_SYM) },
                            { "INTERVAL", SYM(INTERVAL_SYM) },
                            { "INTO", SYM(INTO) },
                            { "IO_THREAD", SYM(RELAY_THREAD) },
                            { "IS", SYM(IS) }, { "ISOLATION", SYM(ISOLATION) },
                            { "ISSUER", SYM(ISSUER_SYM) },
                            { "ITERATE", SYM(ITERATE_SYM) },
                            { "INVOKER", SYM(INVOKER_SYM) },
                            { "JOIN", SYM(JOIN_SYM) }, { "KEY", SYM(KEY_SYM) },
                            { "KEYS", SYM(KEYS) }, { "KILL", SYM(KILL_SYM) },
#ifdef SP_GOTO
                            ...
                            { "LEADING", SYM(LEADING) },
                            { "LEAVE", SYM(LEAVE_SYM) },
                            { "LEAVES", SYM(LEAVES) }, { "LEFT", SYM(LEFT) },
                            { "LEVEL", SYM(LEVEL_SYM) }, { "LIKE", SYM(LIKE) },
                            { "LIMIT", SYM(LIMIT) }, { "LINES", SYM(LINES) },
                            { "LINESTRING", SYM(LINESTRING) },
                            { "LOAD", SYM(LOAD) }, { "LOCAL", SYM(LOCAL_SYM) },
                            ...
                            { "MAX_CONNECTIONS_PER_HOUR",
                              SYM(MAX_CONNECTIONS_PER_HOUR) },
                            { "MAX_QUERIES_PER_HOUR",
                              SYM(MAX_QUERIES_PER_HOUR) },
                            { "MAX_ROWS", SYM(MAX_ROWS) },
                            { "MAX_UPDATES_PER_HOUR",
                              SYM(MAX_UPDATES_PER_HOUR) },
                            ...
                            { "NCHAR", SYM(NCHAR_SYM) },
                            { "NEW", SYM(NEW_SYM) }, { "NEXT", SYM(NEXT_SYM) },
                            { "NO", SYM(NO_SYM) }, { "NONE", SYM(NONE_SYM) },
                            { "NOT", SYM(NOT_SYM) },
                            ...
                            { "ON", SYM(ON) }, { "ONE", SYM(ONE_SYM) },
                            { "ONE_SHOT", SYM(ONE_SHOT_SYM) },
                            { "OPEN", SYM(OPEN_SYM) },
                            { "OPTIMIZE", SYM(OPTIMIZE) },
                            { "OPTION", SYM(OPTION) },
                            { "OPTIONALLY", SYM(OPTIONALLY) },
                            { "OR", SYM(OR_SYM) }, { "ORDER", SYM(ORDER_SYM) },
                            { "OUT", SYM(OUT_SYM) }, { "OUTER", SYM(OUTER) },
                            { "OUTFILE", SYM(OUTFILE) },
                            ...
                            { "READ", SYM(READ_SYM) },
                            { "READS", SYM(READS_SYM) }, { "REAL", SYM(REAL) },
                            ...
                            { "SET", SYM(SET) }, { "SHARE", SYM(SHARE_SYM) },
                            { "SHOW", SYM(SHOW) },
                            ...
                            { "USAGE", SYM(USAGE) }, { "USE", SYM(USE_SYM) },
                            { "USER", SYM(USER) },
                            ...
                            { "WEEK", SYM(WEEK_SYM) },
                            { "WHEN", SYM(WHEN_SYM) }, { "WHERE", SYM(WHERE) },
                            { "WHILE", SYM(WHILE_SYM) },
                            { "VIEW", SYM(VIEW_SYM) }, { "WITH", SYM(WITH) },
                            { "WORK", SYM(WORK_SYM) },
                            { "WRITE", SYM(WRITE_SYM) },
                            { "X509", SYM(X509_SYM) }, { "XOR", SYM(XOR) },
                            { "XA", SYM(XA_SYM) }, { "YEAR", SYM(YEAR_SYM) },
...
static SYMBOL sql_functions[] = {
  ...
  { "BIT_OR", SYM(BIT_OR) }, { "BIT_AND", SYM(BIT_AND) },
  { "BIT_XOR", SYM(BIT_XOR) }, { "CAST", SYM(CAST_SYM) },
  ...
  { "CHARACTER_LENGTH", F_SYM(FUNC_ARG1),
    0,                  CREATE_FUNC(create_func_char_length) },
  { "COALESCE", SYM(COALESCE) }, { "COERCIBILITY",
                                   F_SYM(FUNC_ARG1),
                                   0,
                                   CREATE_FUNC(create_func_coercibility) },
  { "COMPRESS", F_SYM(FUNC_ARG1), 0, CREATE_FUNC(create_func_compress) },
  { "CONCAT", SYM(CONCAT) },
  { "CONCAT_WS", SYM(CONCAT_WS) }, { "CONNECTION_ID",
                                     F_SYM(FUNC_ARG0),
                                     0,
                                     CREATE_FUNC(create_func_connection_id) },
  { "CONV", F_SYM(FUNC_ARG3), 0, CREATE_FUNC(create_func_conv) },
  { "CONVERT_TZ", SYM(CONVERT_TZ_SYM) }, { "COUNT", SYM(COUNT_SYM) },
  ...
  { "CURDATE", SYM(CURDATE) }, { "CURTIME", SYM(CURTIME) },
  ...
  { "ELT", SYM(ELT_FUNC) }, { "ENCODE", SYM(ENCODE_SYM) },
  { "ENCRYPT", SYM(ENCRYPT) },
  ...
  { "EXTERIORRING", F_SYM(FUNC_ARG1),
    0,              CREATE_FUNC_GEOM(create_func_exteriorring) },
  ...
  { "GEOMETRYTYPE", F_SYM(FUNC_ARG1),
    0,              CREATE_FUNC_GEOM(create_func_geometry_type) },
  ...
  { "GEOMFROMTEXT", SYM(GEOMFROMTEXT) }, { "GEOMFROMWKB", SYM(GEOMFROMWKB) },
  { "GLENGTH", F_SYM(FUNC_ARG1), 0, CREATE_FUNC_GEOM(create_func_glength) },
  { "GREATEST", SYM(GREATEST_SYM) }, { "GROUP_CONCAT", SYM(GROUP_CONCAT_SYM) },
  ...
  { "INTERIORRINGN", F_SYM(FUNC_ARG2),
    0,               CREATE_FUNC_GEOM(create_func_interiorringn) },
  ...
  { "LINEFROMTEXT", SYM(LINEFROMTEXT) }, { "LINEFROMWKB", SYM(GEOMFROMWKB) },
  ...
  { "LOCATE", SYM(LOCATE) }, { "LOG", SYM(LOG_SYM) },
  ...
  { "MAX", SYM(MAX_SYM) }, { "MBRCONTAINS",
                             F_SYM(FUNC_ARG2),
                             0,
                             CREATE_FUNC_GEOM(create_func_contains) },
  ...
  { "MBRINTERSECTS", F_SYM(FUNC_ARG2),
    0,               CREATE_FUNC_GEOM(create_func_intersects) },
  ...
  { "MIN", SYM(MIN_SYM) }, { "MLINEFROMTEXT", SYM(MLINEFROMTEXT) },
  { "MLINEFROMWKB", SYM(GEOMFROMWKB) },
  { "MPOINTFROMTEXT", SYM(MPOINTFROMTEXT) },
  { "MPOINTFROMWKB", SYM(GEOMFROMWKB) },
  { "MPOLYFROMTEXT", SYM(MPOLYFROMTEXT) }, { "MPOLYFROMWKB", SYM(GEOMFROMWKB) },
  ...
  { "NUMGEOMETRIES", F_SYM(FUNC_ARG1),
    0,               CREATE_FUNC_GEOM(create_func_numgeometries) },
  { "NUMINTERIORRINGS", F_SYM(FUNC_ARG1),
    0,                  CREATE_FUNC_GEOM(create_func_numinteriorring) },
  ...
  { "POINTFROMTEXT", SYM(POINTFROMTEXT) }, { "POINTFROMWKB", SYM(GEOMFROMWKB) },
  { "POINTN", F_SYM(FUNC_ARG2), 0, CREATE_FUNC_GEOM(create_func_pointn) },
  { "POLYFROMTEXT", SYM(POLYFROMTEXT) }, { "POLYFROMWKB", SYM(GEOMFROMWKB) },
  { "POLYGONFROMTEXT", SYM(POLYFROMTEXT) },
  { "POLYGONFROMWKB", SYM(GEOMFROMWKB) }, { "POSITION", SYM(POSITION_SYM) },
  ...
  { "ROUND", SYM(ROUND) }, { "ROW_COUNT", SYM(ROW_COUNT_SYM) },
  ...
  { "SESSION_USER", SYM(USER) }, { "SUBDATE", SYM(SUBDATE_SYM) },
  ...
  { "UNCOMPRESSED_LENGTH", F_SYM(FUNC_ARG1),
    0,                     CREATE_FUNC(create_func_uncompressed_length) },
  ...
  { "VARIANCE", SYM(VARIANCE_SYM) }, { "VAR_POP", SYM(VARIANCE_SYM) },
