...
struct Query_cache_query {
  ...
  inline gptr query() {
    return (gptr)(((byte *)this) + ALIGN_SIZE(sizeof(Query_cache_query)));
  }
  void lock_writing();
  void lock_reading();
...
struct Query_cache_table {
  ...
  inline gptr data() {
    return (gptr)(((byte *)this) + ALIGN_SIZE(sizeof(Query_cache_table)));
  }
};
...
struct Query_cache_result {
  ...
  inline gptr data() {
    return (gptr)(((byte *)this) + ALIGN_SIZE(sizeof(Query_cache_result)));
  }
...
protected:
  ...
  */
  ...
  static void
  double_linked_list_simple_include(Query_cache_block *point,
                                    Query_cache_block **list_pointer);
  ...
  my_bool allocate_data_chain(Query_cache_block **result_block, ulong data_len,
  ...
  TABLE_COUNTER_TYPE
  register_tables_from_list(TABLE_LIST *tables_used, TABLE_COUNTER_TYPE counter,
                            Query_cache_block_table *block_table);
  my_bool register_all_tables(Query_cache_block *block, TABLE_LIST *tables_used,
                              TABLE_COUNTER_TYPE tables);
  my_bool insert_table(uint key_len, char *key, Query_cache_block_table *node,
  ...
  my_bool move_by_type(byte **border, Query_cache_block **before, ulong *gap,
                       Query_cache_block *i);
  ...
  void pack_cache();
  void relink(Query_cache_block *oblock, Query_cache_block *nblock,
  ...
  */
  ...
  my_bool append_result_data(Query_cache_block **result, ulong data_len,
                             gptr data, Query_cache_block *parent);
  my_bool write_result_data(Query_cache_block **result, ulong data_len,
                            gptr data, Query_cache_block *parent,
                            Query_cache_block::block_type type =
...
public:
  ...
  */
  ...
  my_bool in_table_list(Query_cache_block_table *root,
                        Query_cache_block_table *point, const char *name);
