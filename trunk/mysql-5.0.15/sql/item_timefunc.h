...
class Item_func_period_add : public Item_int_func
{
 public:
  ...
  void fix_length_and_dec() { max_length = 6 * MY_CHARSET_BIN_MB_MAXLEN; }
};
...
class Item_func_weekday : public Item_func
{
 ...
 public:
  ...
  const char *func_name() const { return (odbc_type ? "dayofweek" : "weekday"); }
  enum Item_result result_type() const { return INT_RESULT; }
  void fix_length_and_dec()
  {
    collation.set(&my_charset_bin);
...
class Item_date_func : public Item_str_func
{
 public:
  ...
  Field *tmp_table_field(TABLE *t_arg) { return (new Field_datetime(maybe_null, name, t_arg, &my_charset_bin)); }
};
...
class Item_func_curtime : public Item_func
{
 ...
 public:
  ...
  String *val_str(String *str);
  void fix_length_and_dec();
  Field *tmp_table_field(TABLE *t_arg) { return (new Field_time(maybe_null, name, t_arg, &my_charset_bin)); }
  /*
...
class Item_func_date_format : public Item_str_func
{
 ...
 public:
  ...
  String *val_str(String *str);
  const char *func_name() const { return is_time_format ? "time_format" : "date_format"; }
  void fix_length_and_dec();
...
class Item_func_convert_tz : public Item_date_func
{
 ...
 public:
  Item_func_convert_tz(Item *a, Item *b, Item *c) : Item_date_func(a, b, c), from_tz_cached(0), to_tz_cached(0) {}
  longlong val_int();
...
class Item_extract : public Item_int_func
{
 ...
 public:
  Item_extract(interval_type type_arg, Item *a) : Item_int_func(a), int_type(type_arg) {}
  longlong val_int();
...
class Item_func_add_time : public Item_str_func
{
 ...
 public:
  Item_func_add_time(Item *a, Item *b, bool type_arg, bool neg_arg) : Item_str_func(a, b), is_date(type_arg)
  {
    sign = neg_arg ? -1 : 1;
  }
  String *val_str(String *str);
...
{
 public:
  Item_func_timediff(Item *a, Item *b) : Item_str_func(a, b) {}
  String *val_str(String *str);
...
{
 public:
  Item_func_maketime(Item *a, Item *b, Item *c) : Item_str_func(a, b, c) {}
  String *val_str(String *str);
...
class Item_func_timestamp_diff : public Item_int_func
{
 ...
 public:
  Item_func_timestamp_diff(Item *a, Item *b, interval_type type_arg) : Item_int_func(a, b), int_type(type_arg) {}
...
class Item_func_get_format : public Item_str_func
{
 ...
 public:
  Item_func_get_format(timestamp_type type_arg, Item *a) : Item_str_func(a), type(type_arg) {}
  String *val_str(String *str);
...
class Item_func_str_to_date : public Item_str_func
{
 ...
 public:
  Item_func_str_to_date(Item *a, Item *b) : Item_str_func(a, b) {}
  String *val_str(String *str);
  bool get_date(TIME *ltime, uint fuzzy_date);
