...
public:
  ...
  Item_func_geometry_from_text(Item *a, Item *srid)
      : Item_geometry_func(a, srid) {}
...
public:
  ...
  Item_func_geometry_from_wkb(Item *a, Item *srid)
      : Item_geometry_func(a, srid) {}
...
public:
  ...
  Item_func_point(Item *a, Item *b, Item *srid)
      : Item_geometry_func(a, b, srid) {}
...
public:
  Item_func_spatial_collection(List<Item> &list, enum Geometry::wkbType ct,
