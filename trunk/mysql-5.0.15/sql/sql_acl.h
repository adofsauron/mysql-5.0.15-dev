...
#define DB_ACLS                                                                                               \
  (UPDATE_ACL | SELECT_ACL | INSERT_ACL | DELETE_ACL | CREATE_ACL | DROP_ACL | GRANT_ACL | REFERENCES_ACL |   \
   INDEX_ACL | ALTER_ACL | CREATE_TMP_ACL | LOCK_TABLES_ACL | EXECUTE_ACL | CREATE_VIEW_ACL | SHOW_VIEW_ACL | \
   CREATE_PROC_ACL | ALTER_PROC_ACL)

#define TABLE_ACLS                                                                                          \
  (SELECT_ACL | INSERT_ACL | UPDATE_ACL | DELETE_ACL | CREATE_ACL | DROP_ACL | GRANT_ACL | REFERENCES_ACL | \
   INDEX_ACL | ALTER_ACL | CREATE_VIEW_ACL | SHOW_VIEW_ACL)
...
#define GLOBAL_ACLS                                                                                        \
  (SELECT_ACL | INSERT_ACL | UPDATE_ACL | DELETE_ACL | CREATE_ACL | DROP_ACL | RELOAD_ACL | SHUTDOWN_ACL | \
   PROCESS_ACL | FILE_ACL | GRANT_ACL | REFERENCES_ACL | INDEX_ACL | ALTER_ACL | SHOW_DB_ACL | SUPER_ACL | \
   CREATE_TMP_ACL | LOCK_TABLES_ACL | REPL_SLAVE_ACL | REPL_CLIENT_ACL | EXECUTE_ACL | CREATE_VIEW_ACL |   \
   SHOW_VIEW_ACL | CREATE_PROC_ACL | ALTER_PROC_ACL | CREATE_USER_ACL)
...
#define fix_rights_for_db(A)                                                                          \
  (((A)&DB_CHUNK0) | (((A) << 4) & DB_CHUNK1) | (((A) << 6) & DB_CHUNK2) | (((A) << 9) & DB_CHUNK3) | \
   (((A) << 2) & DB_CHUNK4))
#define get_rights_for_db(A) \
  (((A)&DB_CHUNK0) | (((A)&DB_CHUNK1) >> 4) | (((A)&DB_CHUNK2) >> 6) | (((A)&DB_CHUNK3) >> 9) | (((A)&DB_CHUNK4) >> 2))
#define TBL_CHUNK0 DB_CHUNK0
#define TBL_CHUNK1 DB_CHUNK1
#define TBL_CHUNK2 (CREATE_VIEW_ACL | SHOW_VIEW_ACL)
#define fix_rights_for_table(A) (((A)&TBL_CHUNK0) | (((A) << 4) & TBL_CHUNK1) | (((A) << 11) & TBL_CHUNK2))
#define get_rights_for_table(A) (((A)&TBL_CHUNK0) | (((A)&TBL_CHUNK1) >> 4) | (((A)&TBL_CHUNK2) >> 11))
#define fix_rights_for_column(A) (((A)&7) | (((A) & ~7) << 8))
#define get_rights_for_column(A) (((A)&7) | ((A) >> 8))
#define fix_rights_for_procedure(A) \
  ((((A) << 18) & EXECUTE_ACL) | (((A) << 23) & ALTER_PROC_ACL) | (((A) << 8) & GRANT_ACL))
#define get_rights_for_procedure(A) ((((A)&EXECUTE_ACL) >> 18) | (((A)&ALTER_PROC_ACL) >> 23) | (((A)&GRANT_ACL) >> 8))
...
bool mysql_table_grant(THD *thd, TABLE_LIST *table, List<LEX_USER> &user_list, List<LEX_COLUMN> &column_list,
                       ulong rights, bool revoke);
bool mysql_routine_grant(THD *thd, TABLE_LIST *table, bool is_proc, List<LEX_USER> &user_list, ulong rights,
                         bool revoke, bool no_error);
ACL_USER *check_acl_user(LEX_USER *user_name, uint *acl_acl_userdx);
my_bool grant_init();
void grant_free(void);
my_bool grant_reload(THD *thd);
bool check_grant(THD *thd, ulong want_access, TABLE_LIST *tables, uint show_command, uint number,
...
bool check_grant_column(THD *thd, GRANT_INFO *grant, const char *db_name, const char *table_name, const char *name,
                        uint length, uint show_command = 0);
...
ulong get_column_grant(THD *thd, GRANT_INFO *grant, const char *db_name, const char *table_name,
