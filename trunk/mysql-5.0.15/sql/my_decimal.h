...
inline int binary2my_decimal(uint mask, const char *bin, my_decimal *d,
                             int prec, int scale) {
  return check_result(mask,
                      bin2decimal((char *)bin, (decimal_t *)d, prec, scale));
}
...
inline int my_decimal2int(uint mask, const my_decimal *d, my_bool unsigned_flag,
                          longlong *l) {
  my_decimal rounded;
...
inline int int2my_decimal(uint mask, longlong i, my_bool unsigned_flag,
                          my_decimal *d) {
  return check_result(mask, (unsigned_flag ? ulonglong2decimal((ulonglong)i, d)
...
inline int my_decimal_div(uint mask, my_decimal *res, const my_decimal *a,
  ...
  return check_result(
      mask, decimal_div((decimal_t *)a, (decimal_t *)b, res, div_scale_inc));
}
