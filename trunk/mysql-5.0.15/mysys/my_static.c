...
char NEAR curr_dir[FN_REFLEN] = {0}, NEAR home_dir_buff[FN_REFLEN] = {0};
...
byte *sf_min_adress = (byte *)~(unsigned long)0L, *sf_max_adress = (byte *)0L;
...
int (*error_handler_hook)(uint error, const char *str, myf MyFlags) = my_message_no_curses;
int (*fatal_error_handler_hook)(uint error, const char *str, myf MyFlags) = my_message_no_curses;
