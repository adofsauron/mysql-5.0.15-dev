...
/* Waiting lock flag */
#define LOCK_WAIT                               \
  256 /* this wait bit should be so high that   \
...
#define LOCK_ORDINARY                              \
  0 /* this flag denotes an ordinary next-key lock \
    in contrast to LOCK_GAP or LOCK_REC_NOT_GAP */
#define LOCK_GAP                                     \
  512 /* this gap bit should be so high that         \
